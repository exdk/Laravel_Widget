...
<div class="card">
    <div class="card-header">
        <h4>Добавление пункта погрузки/выгрузки</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control mask-phone {{ $errors->has('mobileload') ? 'is-invalid' : '' }}" type="text" name="mobileload" id="mobileload" value="{{ old('mobileload', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('pnot') ? 'is-invalid' : '' }}" type="text" name="pnot" id="pnot" value="09:00">
                @if($errors->has('pnot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('pndo') ? 'is-invalid' : '' }}" type="text" name="pndo" id="pndo" value="22:00">
                @if($errors->has('pndo'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('pnbrot') ? 'is-invalid' : '' }}" type="text" name="pnbrot" id="pnbrot" value="14:00">
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('pnbrdo') ? 'is-invalid' : '' }}" type="text" name="pnbrdo" id="pnbrdo" value="15:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('thot') ? 'is-invalid' : '' }}" type="text" name="thot" id="thot" value="09:00">
                @if($errors->has('thot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('thdo') ? 'is-invalid' : '' }}" type="text" name="thdo" id="thdo" value="22:00">
                @if($errors->has('thdo'))
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time {{ $errors->has('thbrot') ? 'is-invalid' : '' }}" type="text" name="thbrot" id="thbrot" value="14:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('thbrdo') ? 'is-invalid' : '' }}" type="text" name="thbrdo" id="thbrdo" value="15:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('wedot') ? 'is-invalid' : '' }}" type="text" name="wedot" id="wedot" value="09:00">
                @if($errors->has('wedot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('weddo') ? 'is-invalid' : '' }}" type="text" name="weddo" id="weddo" value="22:00">
                @if($errors->has('weddo'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('wedbrot') ? 'is-invalid' : '' }}" type="text" name="wedbrot" id="wedbrot" value="14:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('wedbrto') ? 'is-invalid' : '' }}" type="text" name="wedbrto" id="wedbrto" value="15:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('thuot') ? 'is-invalid' : '' }}" type="text" name="thuot" id="thuot" value="09:00">
                @if($errors->has('thuot'))
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('thudo') ? 'is-invalid' : '' }}" type="text" name="thudo" id="thudo" value="22:00">
                @if($errors->has('thudo'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('thubrot') ? 'is-invalid' : '' }}" type="text" name="thubrot" id="thubrot" value="14:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('thubrdo') ? 'is-invalid' : '' }}" type="text" name="thubrdo" id="thubrdo" value="15:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('friot') ? 'is-invalid' : '' }}" type="text" name="friot" id="friot" value="09:00">
                @if($errors->has('friot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('frido') ? 'is-invalid' : '' }}" type="text" name="frido" id="frido" value="22:00">
                @if($errors->has('frido'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('fribrot') ? 'is-invalid' : '' }}" type="text" name="fribrot" id="fribrot" value="14:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('fribrdo') ? 'is-invalid' : '' }}" type="text" name="fribrdo" id="fribrdo" value="15:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('satot') ? 'is-invalid' : '' }}" type="text" name="satot" id="satot" value="09:00">
                @if($errors->has('satot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('satdo') ? 'is-invalid' : '' }}" type="text" name="satdo" id="satdo" value="22:00">
                @if($errors->has('satdo'))
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('satbrot') ? 'is-invalid' : '' }}" type="text" name="satbrot" id="satbrot" value="14:00">
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('satbrdo') ? 'is-invalid' : '' }}" type="text" name="satbrdo" id="satbrdo" value="15:00">
           ...
           <div class="col-3"> <div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('sunot') ? 'is-invalid' : '' }}" type="text" name="sunot" id="sunot" value="09:00">
                @if($errors->has('sunot'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('sundo') ? 'is-invalid' : '' }}" type="text" name="sundo" id="sundo" value="22:00">
                @if($errors->has('sundo'))
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('sunbrot') ? 'is-invalid' : '' }}" type="text" name="sunbrot" id="sunbrot" value="14:00">
            ...
            <div class="col-3"><div class="form-group">
                ...
                <input class="form-control time{{ $errors->has('sunbrdo') ? 'is-invalid' : '' }}" type="text" name="sunbrdo" id="sunbrdo" value="15:00">
