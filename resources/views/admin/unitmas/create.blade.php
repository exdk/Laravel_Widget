...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.unitma.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.unitmas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="titleru">{{ trans('cruds.unitma.fields.titleru') }}</label>
                <input class="form-control {{ $errors->has('titleru') ? 'is-invalid' : '' }}" type="text" name="titleru" id="titleru" value="{{ old('titleru', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rubol') ? 'is-invalid' : '' }}" type="text" name="rubol" id="rubol" value="{{ old('rubol', '') }}">
                @if($errors->has('rubol'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('megd') ? 'is-invalid' : '' }}" type="text" name="megd" id="megd" value="{{ old('megd', '') }}">
                @if($errors->has('megd'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('megd_bol') ? 'is-invalid' : '' }}" type="text" name="megd_bol" id="megd_bol" value="{{ old('megd_bol', '') }}">
