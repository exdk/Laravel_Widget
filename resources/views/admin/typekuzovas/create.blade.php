...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.typekuzova.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.typekuzovas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="typekuzova">{{ trans('cruds.typekuzova.fields.typekuzova') }}</label>
                <input class="form-control {{ $errors->has('typekuzova') ? 'is-invalid' : '' }}" type="text" name="typekuzova" id="typekuzova" value="{{ old('typekuzova', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('korot') ? 'is-invalid' : '' }}" type="text" name="korot" id="korot" value="{{ old('korot', '') }}">
                @if($errors->has('korot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('world') ? 'is-invalid' : '' }}" type="text" name="world" id="world" value="{{ old('world', '') }}">
                @if($errors->has('world'))
