...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.gruz.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.gruzs.update", [$gruz->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="title">{{ trans('cruds.gruz.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $gruz->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kor') ? 'is-invalid' : '' }}" type="text" name="kor" id="kor" value="{{ old('kor', $gruz->kor) }}">
                @if($errors->has('kor'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gruz') ? 'is-invalid' : '' }}" type="text" name="gruz" id="gruz" value="{{ old('gruz', $gruz->gruz) }}">
                @if($errors->has('gruz'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('di') ? 'is-invalid' : '' }}" type="text" name="di" id="di" value="{{ old('di', $gruz->di) }}">
                @if($errors->has('di'))
