...
<div class="row">
    <div class="col-9">
        <form method="POST" action="{{ route("admin.autos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Auto::TYPE_KUZOV_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type_kuzov') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_kuzov_{{ $key }}" name="type_kuzov" value="{{ $key }}" {{ old('type_kuzov', '1') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Auto::OWN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('own') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="own_{{ $key }}" name="own" value="{{ $key }}" {{ old('own', '') === (string) $key ? 'checked' : '' }}>
...
<div class="row">
    <div class="col-4">
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('own_inn') ? 'is-invalid' : '' }}" type="text" name="own_inn" id="own_inn" value="{{ old('own_inn', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control govnomer {{ $errors->has('govnomer') ? 'is-invalid' : '' }}" type="text" name="govnomer" id="govnomer" value="{{ old('govnomer', '') }}">
...
<div class="row">
    <div class="col-4">
        ...
        <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marka') ? 'is-invalid' : '' }}" type="text" name="marka" id="marka" value="{{ old('marka', '') }}">
                @if($errors->has('marka'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_ot') ? 'is-invalid' : '' }}" type="text" name="year_ot" id="year_ot" value="{{ old('year_ot', '') }}">
...
<div class="card-body">     
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_tc') ? 'is-invalid' : '' }}" type="text" name="category_tc" id="category_tc" value="{{ old('category_tc', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('horse') ? 'is-invalid' : '' }}" type="text" name="horse" id="horse" value="{{ old('horse', '') }}">
                @if($errors->has('horse'))
 ...
 <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ecoclass') ? 'is-invalid' : '' }}" type="text" name="ecoclass" id="ecoclass" value="{{ old('ecoclass', '') }}">
            ...
            <div class="col-4">  
                ...
                <input class="form-control {{ $errors->has('max_nagruz') ? 'is-invalid' : '' }}" type="text" name="max_nagruz" id="max_nagruz" value="{{ old('max_nagruz', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beznagruz') ? 'is-invalid' : '' }}" type="text" name="beznagruz" id="beznagruz" value="{{ old('beznagruz', '') }}">
 ...
 <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control pt_type {{ $errors->has('pt_type') ? 'is-invalid' : '' }}" type="text" name="pt_type" id="pt_type" value="{{ old('pt_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control pt_nomer {{ $errors->has('pt_nomer') ? 'is-invalid' : '' }}" type="text" name="pt_nomer" id="pt_nomer" value="{{ old('pt_nomer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pt_date') ? 'is-invalid' : '' }}" type="text" name="pt_date" id="pt_date" value="{{ old('pt_date') }}">
...
<div class="row">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Auto::ENGINE_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('engine_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="engine_type_{{ $key }}" name="engine_type" value="{{ $key }}" {{ old('engine_type', '1') === (string) $key ? 'checked' : '' }}>
    ...
    <div class="col-3"> 
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fuel') ? 'is-invalid' : '' }}" type="text" name="fuel" id="fuel" value="{{ old('fuel', '') }}">
                @if($errors->has('fuel'))
    ...
    <div class="col-2"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gruzopod') ? 'is-invalid' : '' }}" type="text" name="gruzopod" id="gruzopod" value="{{ old('gruzopod', '') }}">
    ...
    <div class="col-2"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('levelco_2') ? 'is-invalid' : '' }}" type="text" name="levelco_2" id="levelco_2" value="{{ old('levelco_2', '') }}">
            ...
            <div class="form-group" style="">
                ...
                <input class="form-control {{ $errors->has('registry') ? 'is-invalid' : '' }}" type="text" name="registry" id="registry" value="{{ old('registry', '') }}">
...
<div class="row">
      <div class="col-3">
            <div class="form-group">
                ...
                @foreach(App\Models\Auto::KOLO_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('kolo') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="kolo_{{ $key }}" name="kolo" value="{{ $key }}" {{ old('kolo', '1') === (string) $key ? 'checked' : '' }}>
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bakov') ? 'is-invalid' : '' }}" type="text" name="bakov" id="bakov" value="{{ old('bakov', '') }}">
                @if($errors->has('bakov'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bakov_volume') ? 'is-invalid' : '' }}" type="text" name="bakov_volume" id="bakov_volume" value="{{ old('bakov_volume', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bakov_volume_2') ? 'is-invalid' : '' }}" type="text" name="bakov_volume_2" id="bakov_volume_2" value="{{ old('bakov_volume_2', '') }}">
 ...
 <div class="row">
        <div class="col-3"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutr_dlina') ? 'is-invalid' : '' }}" type="text" name="vnutr_dlina" id="vnutr_dlina" value="{{ old('vnutr_dlina', '') }}">
        ...
        <div class="col-3"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutr_weight') ? 'is-invalid' : '' }}" type="text" name="vnutr_weight" id="vnutr_weight" value="{{ old('vnutr_weight', '') }}">
        ...
        <div class="col-3"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutr_height') ? 'is-invalid' : '' }}" type="text" name="vnutr_height" id="vnutr_height" value="{{ old('vnutr_height', '') }}">
        ...
        <div class="col-3"> 
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutr_kub') ? 'is-invalid' : '' }}" type="text" name="vnutr_kub" id="vnutr_kub" value="{{ old('vnutr_kub', '') }}">
 ...
 <div class="row">
        <div class="col-4">
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holod') ? 'is-invalid' : '' }}" type="text" name="holod" id="holod" value="{{ old('holod', '') }}">
                @if($errors->has('holod'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('temp_ot') ? 'is-invalid' : '' }}" type="text" name="temp_ot" id="temp_ot" value="{{ old('temp_ot', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('temp_do') ? 'is-invalid' : '' }}" type="text" name="temp_do" id="temp_do" value="{{ old('temp_do', '') }}">
 ...
 <div class="row">
        <div class="col-4">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('palet') ? 'is-invalid' : '' }}" type="text" name="palet" id="palet" value="{{ old('palet', '') }}">
                @if($errors->has('palet'))
 ...
 <div class="row">
        <div class="col-6">
                ...
                <input class="form-control {{ $errors->has('type_tahograf') ? 'is-invalid' : '' }}" type="text" name="type_tahograf" id="type_tahograf" value="{{ old('type_tahograf', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gidrolift') ? 'is-invalid' : '' }}" type="text" name="gidrolift" id="gidrolift" value="{{ old('gidrolift', '') }}">
    ...
    <div class="col-3">
            <div class="form-group">
                <div class="form-check {{ $errors->has('remni') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="remni" id="remni" value="1" {{ old('remni', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Auto::TYPE_KABIN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type_kabin') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_kabin_{{ $key }}" name="type_kabin" value="{{ $key }}" {{ old('type_kabin', '') === (string) $key ? 'checked' : '' }}>
...
<div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operator_gps') ? 'is-invalid' : '' }}" type="text" name="operator_gps" id="operator_gps" value="{{ old('operator_gps', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_dat_gps') ? 'is-invalid' : '' }}" type="text" name="nomer_dat_gps" id="nomer_dat_gps" value="{{ old('nomer_dat_gps', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_mac') ? 'is-invalid' : '' }}" type="text" name="nomer_mac" id="nomer_mac" value="{{ old('nomer_mac', '') }}">
...
<div class="row">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('rozisk') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="rozisk" id="rozisk" value="1" {{ old('rozisk', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('zalog') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="zalog" id="zalog" value="1" {{ old('zalog', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('htraf_gibdd') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="htraf_gibdd" id="htraf_gibdd" value="1" {{ old('htraf_gibdd', 0) == 1 ? 'checked' : '' }}>
...
<div class="card-body">     
        <div class="row">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.auto.fields.color_helper') }}</span>
            </div></div><div class="col-4" style="display:none;">
            <div class="form-group" >
                <label for="horse">{{ trans('cruds.auto.fields.horse') }}</label>
                <input class="form-control {{ $errors->has('horse') ? 'is-invalid' : '' }}" type="text" name="horse" id="horse" value="{{ old('horse', '') }}">
                @if($errors->has('horse'))
      ...
      <div class="col-3">
        ...
        <div class="col-3" style="display:none;">
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.auto.fields.bakov_helper') }}</span>
            </div></div><div class="col-3" style="display:none;">
            <div class="form-group">
                <label for="bakov_volume">{{ trans('cruds.auto.fields.bakov_volume') }}</label>
                <input class="form-control {{ $errors->has('bakov_volume') ? 'is-invalid' : '' }}" type="text" name="bakov_volume" id="bakov_volume" value="{{ old('bakov_volume', '') }}">
                @if($errors->has('bakov_volume'))
...
<div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control ob_type{{ $errors->has('ob_type') ? 'is-invalid' : '' }}" type="text" name="ob_type" id="ob_type" value="{{ old('ob_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control op_nemer{{ $errors->has('op_nemer') ? 'is-invalid' : '' }}" type="text" name="op_nemer" id="op_nemer" value="{{ old('op_nemer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ob_date_ot') ? 'is-invalid' : '' }}" type="text" name="ob_date_ot" id="ob_date_ot" value="{{ old('ob_date_ot') }}">
...
<div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ka_type') ? 'is-invalid' : '' }}" type="text" name="ka_type" id="ka_type" value="{{ old('ka_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ka_nomer') ? 'is-invalid' : '' }}" type="text" name="ka_nomer" id="ka_nomer" value="{{ old('ka_nomer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('ka_date_ot') ? 'is-invalid' : '' }}" type="text" name="ka_date_ot" id="ka_date_ot" value="{{ old('ka_date_ot') }}">
...
<a href="#ko" style="width:100%;"><button class="btn btn-outline-primary">Характеристики</button></a>
<a href="#re" style="width:100%;"><button class="btn btn-outline-primary">Документы</button></a>
</div>
</div> 
    </div>
     <div class="card">
         <div class="card-header">
             <h6>Данные заполнены на: </h6>
         </div>
       <div class="card-body ">
<div class="progress">
...
<script>
    $('input[name="type_kuzov"]').click(function(){
