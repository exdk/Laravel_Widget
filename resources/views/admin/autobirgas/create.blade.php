...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.autobirga.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.autobirgas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('typekuz') ? 'is-invalid' : '' }}" name="typekuz_id" id="typekuz_id">
                    @foreach($typekuzs as $id => $entry)
                        <option value="{{ $id }}" {{ old('typekuz_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Autobirga::AUTOTYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('autotype') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="autotype_{{ $key }}" name="autotype" value="{{ $key }}" {{ old('autotype', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('loverh') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="loverh" id="loverh" value="1" {{ old('loverh', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lobok') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lobok" id="lobok" value="1" {{ old('lobok', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lozad') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lozad" id="lozad" value="1" {{ old('lozad', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lopoln') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lopoln" id="lopoln" value="1" {{ old('lopoln', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lopop') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lopop" id="lopop" value="1" {{ old('lopop', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lotoiki') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lotoiki" id="lotoiki" value="1" {{ old('lotoiki', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lovorot') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lovorot" id="lovorot" value="1" {{ old('lovorot', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('logidrobort') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="logidrobort" id="logidrobort" value="1" {{ old('logidrobort', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('loapp') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="loapp" id="loapp" value="1" {{ old('loapp', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lobreh') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lobreh" id="lobreh" value="1" {{ old('lobreh', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lobort') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lobort" id="lobort" value="1" {{ old('lobort', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('loboko') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="loboko" id="loboko" value="1" {{ old('loboko', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('dogruz') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="dogruz" id="dogruz" value="1" {{ old('dogruz', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hydrolift') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hydrolift" id="hydrolift" value="1" {{ old('hydrolift', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('koniki') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="koniki" id="koniki" value="1" {{ old('koniki', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gruzoton') ? 'is-invalid' : '' }}" type="number" name="gruzoton" id="gruzoton" value="{{ old('gruzoton', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('volume') ? 'is-invalid' : '' }}" type="number" name="volume" id="volume" value="{{ old('volume', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lengthpri') ? 'is-invalid' : '' }}" type="number" name="lengthpri" id="lengthpri" value="{{ old('lengthpri', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('widthpri') ? 'is-invalid' : '' }}" type="number" name="widthpri" id="widthpri" value="{{ old('widthpri', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('heightpri') ? 'is-invalid' : '' }}" type="number" name="heightpri" id="heightpri" value="{{ old('heightpri', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tir') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tir" id="tir" value="1" {{ old('tir', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('ekmt') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="ekmt" id="ekmt" value="1" {{ old('ekmt', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('adrs') ? 'is-invalid' : '' }}" name="adrs[]" id="adrs" multiple>
                    @foreach($adrs as $id => $adr)
                        <option value="{{ $id }}" {{ in_array($id, old('adrs', [])) ? 'selected' : '' }}>{{ $adr }}</option>
                    @endforeach
                </select>
                @if($errors->has('adrs'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('fromcou') ? 'is-invalid' : '' }}" name="fromcou_id" id="fromcou_id">
                    @foreach($fromcous as $id => $entry)
                        <option value="{{ $id }}" {{ old('fromcou_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromzip') ? 'is-invalid' : '' }}" type="text" name="fromzip" id="fromzip" value="{{ old('fromzip', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromregion') ? 'is-invalid' : '' }}" type="text" name="fromregion" id="fromregion" value="{{ old('fromregion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromcity') ? 'is-invalid' : '' }}" type="text" name="fromcity" id="fromcity" value="{{ old('fromcity', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromulitca') ? 'is-invalid' : '' }}" type="text" name="fromulitca" id="fromulitca" value="{{ old('fromulitca', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromdom') ? 'is-invalid' : '' }}" type="text" name="fromdom" id="fromdom" value="{{ old('fromdom', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromlong') ? 'is-invalid' : '' }}" type="text" name="fromlong" id="fromlong" value="{{ old('fromlong', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromlat') ? 'is-invalid' : '' }}" type="text" name="fromlat" id="fromlat" value="{{ old('fromlat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fromrad') ? 'is-invalid' : '' }}" type="text" name="fromrad" id="fromrad" value="{{ old('fromrad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tocou') ? 'is-invalid' : '' }}" type="text" name="tocou" id="tocou" value="{{ old('tocou', '') }}">
                @if($errors->has('tocou'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tozip') ? 'is-invalid' : '' }}" type="text" name="tozip" id="tozip" value="{{ old('tozip', '') }}">
                @if($errors->has('tozip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('toregion') ? 'is-invalid' : '' }}" type="text" name="toregion" id="toregion" value="{{ old('toregion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tocity') ? 'is-invalid' : '' }}" type="text" name="tocity" id="tocity" value="{{ old('tocity', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('toulitca') ? 'is-invalid' : '' }}" type="text" name="toulitca" id="toulitca" value="{{ old('toulitca', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('todom') ? 'is-invalid' : '' }}" type="text" name="todom" id="todom" value="{{ old('todom', '') }}">
                @if($errors->has('todom'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tolong') ? 'is-invalid' : '' }}" type="text" name="tolong" id="tolong" value="{{ old('tolong', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tolat') ? 'is-invalid' : '' }}" type="text" name="tolat" id="tolat" value="{{ old('tolat', '') }}">
                @if($errors->has('tolat'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('torad') ? 'is-invalid' : '' }}" type="text" name="torad" id="torad" value="{{ old('torad', '') }}">
                @if($errors->has('torad'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_1_rad') ? 'is-invalid' : '' }}" type="text" name="dop_1_rad" id="dop_1_rad" value="{{ old('dop_1_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_2_rad') ? 'is-invalid' : '' }}" type="text" name="dop_2_rad" id="dop_2_rad" value="{{ old('dop_2_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_3_rad') ? 'is-invalid' : '' }}" type="text" name="dop_3_rad" id="dop_3_rad" value="{{ old('dop_3_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_4_rad') ? 'is-invalid' : '' }}" type="text" name="dop_4_rad" id="dop_4_rad" value="{{ old('dop_4_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_5_rad') ? 'is-invalid' : '' }}" type="text" name="dop_5_rad" id="dop_5_rad" value="{{ old('dop_5_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_6_adr') ? 'is-invalid' : '' }}" type="text" name="dop_6_adr" id="dop_6_adr" value="{{ old('dop_6_adr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_6_rad') ? 'is-invalid' : '' }}" type="text" name="dop_6_rad" id="dop_6_rad" value="{{ old('dop_6_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_6_tot') ? 'is-invalid' : '' }}" type="text" name="dop_6_tot" id="dop_6_tot" value="{{ old('dop_6_tot', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_6_val') ? 'is-invalid' : '' }}" name="dop_6_val_id" id="dop_6_val_id">
                    @foreach($dop_6_vals as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_6_val_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_6_typ') ? 'is-invalid' : '' }}" name="dop_6_typ_id" id="dop_6_typ_id">
                    @foreach($dop_6_typs as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_6_typ_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_7_adr') ? 'is-invalid' : '' }}" type="text" name="dop_7_adr" id="dop_7_adr" value="{{ old('dop_7_adr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_7_rad') ? 'is-invalid' : '' }}" type="text" name="dop_7_rad" id="dop_7_rad" value="{{ old('dop_7_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_7_tot') ? 'is-invalid' : '' }}" type="text" name="dop_7_tot" id="dop_7_tot" value="{{ old('dop_7_tot', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_7_val') ? 'is-invalid' : '' }}" name="dop_7_val_id" id="dop_7_val_id">
                    @foreach($dop_7_vals as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_7_val_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_7_typ') ? 'is-invalid' : '' }}" name="dop_7_typ_id" id="dop_7_typ_id">
                    @foreach($dop_7_typs as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_7_typ_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_8_adr') ? 'is-invalid' : '' }}" type="text" name="dop_8_adr" id="dop_8_adr" value="{{ old('dop_8_adr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_8_rad') ? 'is-invalid' : '' }}" type="text" name="dop_8_rad" id="dop_8_rad" value="{{ old('dop_8_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_8_tot') ? 'is-invalid' : '' }}" type="text" name="dop_8_tot" id="dop_8_tot" value="{{ old('dop_8_tot', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_8_val') ? 'is-invalid' : '' }}" name="dop_8_val_id" id="dop_8_val_id">
                    @foreach($dop_8_vals as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_8_val_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_8_typ') ? 'is-invalid' : '' }}" name="dop_8_typ_id" id="dop_8_typ_id">
                    @foreach($dop_8_typs as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_8_typ_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_9_adr') ? 'is-invalid' : '' }}" type="text" name="dop_9_adr" id="dop_9_adr" value="{{ old('dop_9_adr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_9_rad') ? 'is-invalid' : '' }}" type="text" name="dop_9_rad" id="dop_9_rad" value="{{ old('dop_9_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_9_tot') ? 'is-invalid' : '' }}" type="text" name="dop_9_tot" id="dop_9_tot" value="{{ old('dop_9_tot', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_9_typ') ? 'is-invalid' : '' }}" name="dop_9_typ_id" id="dop_9_typ_id">
                    @foreach($dop_9_typs as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_9_typ_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_9_val') ? 'is-invalid' : '' }}" name="dop_9_val_id" id="dop_9_val_id">
                    @foreach($dop_9_vals as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_9_val_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_10_adr') ? 'is-invalid' : '' }}" type="text" name="dop_10_adr" id="dop_10_adr" value="{{ old('dop_10_adr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_10_rad') ? 'is-invalid' : '' }}" type="text" name="dop_10_rad" id="dop_10_rad" value="{{ old('dop_10_rad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_10_tot') ? 'is-invalid' : '' }}" type="text" name="dop_10_tot" id="dop_10_tot" value="{{ old('dop_10_tot', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_10_val') ? 'is-invalid' : '' }}" name="dop_10_val_id" id="dop_10_val_id">
                    @foreach($dop_10_vals as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_10_val_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_10_typ') ? 'is-invalid' : '' }}" name="dop_10_typ_id" id="dop_10_typ_id">
                    @foreach($dop_10_typs as $id => $entry)
                        <option value="{{ $id }}" {{ old('dop_10_typ_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Autobirga::READYLOAD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('readyload') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="readyload_{{ $key }}" name="readyload" value="{{ $key }}" {{ old('readyload', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dateloadplu') ? 'is-invalid' : '' }}" type="text" name="dateloadplu" id="dateloadplu" value="{{ old('dateloadplu') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('type_load') ? 'is-invalid' : '' }}" name="type_load_id" id="type_load_id">
                    @foreach($type_loads as $id => $entry)
                        <option value="{{ $id }}" {{ old('type_load_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oplatanal') ? 'is-invalid' : '' }}" type="text" name="oplatanal" id="oplatanal" value="{{ old('oplatanal', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('oplataval') ? 'is-invalid' : '' }}" name="oplataval_id" id="oplataval_id">
                    @foreach($oplatavals as $id => $entry)
                        <option value="{{ $id }}" {{ old('oplataval_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oplatawithnds') ? 'is-invalid' : '' }}" type="text" name="oplatawithnds" id="oplatawithnds" value="{{ old('oplatawithnds', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oplatanonds') ? 'is-invalid' : '' }}" type="text" name="oplatanonds" id="oplatanonds" value="{{ old('oplatanonds', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopinfo') ? 'is-invalid' : '' }}" type="text" name="dopinfo" id="dopinfo" value="{{ old('dopinfo', '') }}">
