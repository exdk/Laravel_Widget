                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td bgcolor="#F6F6F6" style="border-collapse:collapse;color:#333333;font-family:'calibri' , sans-serif;font-size:16px;padding:10px">
											<strong>Грузовладелец</strong>: {{$gruzovladelets->hortname}}<br>
											<strong>TMS</strong>: 
											<a href="#" target="_blank" style="color:#284a98;padding:0;text-decoration:underline" data-link-id="1" rel="noopener noreferrer">[ID: {{$lead->id}}]</a>
											<br>
											<strong>Дата начала</strong>: {{$lead->date_start}}<br>
											<strong>Дата окончания</strong>: {{$lead->date_end}}<br>
											<strong>Комментарий</strong>: {{$lead->comment}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                       <td bgcolor="#FFFFFF" style="border-collapse:collapse;color:#333333;font-family:'calibri' , sans-serif;font-size:16px;padding:10px">
                                          <div>Dear Sir or Madam,<br><br>the aforementioned preselection will end on {{$lead->date_end}}. We request that you submit an offer in Freight Procurement under 
										  ...
										  <br><br>Диспетчер грузоотправителя: {{$dispatcher->surname." ".$dispatcher->name." ".$dispatcher->oth}}</div>
                                          <!--<div>Компания: «»<br>-->
											<span class="ca6710e1bb46a547js-phone-number_mr_css_attr">{{$dispatcher->mobile}}</span><br>
											<a href="http://e.mail.ru/compose/?mailto={{$dispatcher->email}}" target="_blank" data-link-id="3" rel="noopener noreferrer">{{$dispatcher->email}}</a>
										  </div>
										  @endif
                                       </td>
                                    </tr>
