...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.uncomfirmed.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.uncomfirmeds.update", [$uncomfirmed->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="transpareon">{{ trans('cruds.uncomfirmed.fields.transpareon') }}</label>
                <input class="form-control {{ $errors->has('transpareon') ? 'is-invalid' : '' }}" type="text" name="transpareon" id="transpareon" value="{{ old('transpareon', $uncomfirmed->transpareon) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolonka') ? 'is-invalid' : '' }}" type="text" name="kolonka" id="kolonka" value="{{ old('kolonka', $uncomfirmed->kolonka) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transportnoe_sredstvo_trebovanie') ? 'is-invalid' : '' }}" type="text" name="transportnoe_sredstvo_trebovanie" id="transportnoe_sredstvo_trebovanie" value="{{ old('transportnoe_sredstvo_trebovanie', $uncomfirmed->transportnoe_sredstvo_trebovanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ves') ? 'is-invalid' : '' }}" type="text" name="ves" id="ves" value="{{ old('ves', $uncomfirmed->ves) }}">
                @if($errors->has('ves'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obem') ? 'is-invalid' : '' }}" type="text" name="obem" id="obem" value="{{ old('obem', $uncomfirmed->obem) }}">
                @if($errors->has('obem'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dlina') ? 'is-invalid' : '' }}" type="text" name="dlina" id="dlina" value="{{ old('dlina', $uncomfirmed->dlina) }}">
                @if($errors->has('dlina'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pozicii') ? 'is-invalid' : '' }}" type="text" name="pozicii" id="pozicii" value="{{ old('pozicii', $uncomfirmed->pozicii) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strana_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="strana_mesto_naznacheniya" id="strana_mesto_naznacheniya" value="{{ old('strana_mesto_naznacheniya', $uncomfirmed->strana_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutrenniy_kommentariy_k_perevozke') ? 'is-invalid' : '' }}" type="text" name="vnutrenniy_kommentariy_k_perevozke" id="vnutrenniy_kommentariy_k_perevozke" value="{{ old('vnutrenniy_kommentariy_k_perevozke', $uncomfirmed->vnutrenniy_kommentariy_k_perevozke) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_gryppi_perevozok') ? 'is-invalid' : '' }}" type="text" name="id_gryppi_perevozok" id="id_gryppi_perevozok" value="{{ old('id_gryppi_perevozok', $uncomfirmed->id_gryppi_perevozok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelnie_nomera_gryzootpravitelya') ? 'is-invalid' : '' }}" type="text" name="dopolnitelnie_nomera_gryzootpravitelya" id="dopolnitelnie_nomera_gryzootpravitelya" value="{{ old('dopolnitelnie_nomera_gryzootpravitelya', $uncomfirmed->dopolnitelnie_nomera_gryzootpravitelya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelniy_n_gryzootpravitelya_2') ? 'is-invalid' : '' }}" type="text" name="dopolnitelniy_n_gryzootpravitelya_2" id="dopolnitelniy_n_gryzootpravitelya_2" value="{{ old('dopolnitelniy_n_gryzootpravitelya_2', $uncomfirmed->dopolnitelniy_n_gryzootpravitelya_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pochtoviy_indeks_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="pochtoviy_indeks_mesto_naznacheniya" id="pochtoviy_indeks_mesto_naznacheniya" value="{{ old('pochtoviy_indeks_mesto_naznacheniya', $uncomfirmed->pochtoviy_indeks_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelniy_n_gryzootpravitelya_3') ? 'is-invalid' : '' }}" type="text" name="dopolnitelniy_n_gryzootpravitelya_3" id="dopolnitelniy_n_gryzootpravitelya_3" value="{{ old('dopolnitelniy_n_gryzootpravitelya_3', $uncomfirmed->dopolnitelniy_n_gryzootpravitelya_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kategorii') ? 'is-invalid' : '' }}" type="text" name="kategorii" id="kategorii" value="{{ old('kategorii', $uncomfirmed->kategorii) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dispetcher_gryzootpravitelya') ? 'is-invalid' : '' }}" type="text" name="dispetcher_gryzootpravitelya" id="dispetcher_gryzootpravitelya" value="{{ old('dispetcher_gryzootpravitelya', $uncomfirmed->dispetcher_gryzootpravitelya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pochtoviy_indeks_start') ? 'is-invalid' : '' }}" type="text" name="pochtoviy_indeks_start" id="pochtoviy_indeks_start" value="{{ old('pochtoviy_indeks_start', $uncomfirmed->pochtoviy_indeks_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_start') ? 'is-invalid' : '' }}" type="text" name="region_start" id="region_start" value="{{ old('region_start', $uncomfirmed->region_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strana_start') ? 'is-invalid' : '' }}" type="text" name="strana_start" id="strana_start" value="{{ old('strana_start', $uncomfirmed->strana_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_start') ? 'is-invalid' : '' }}" type="text" name="kommentariy_start" id="kommentariy_start" value="{{ old('kommentariy_start', $uncomfirmed->kommentariy_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otdel_planirovaniya') ? 'is-invalid' : '' }}" type="text" name="otdel_planirovaniya" id="otdel_planirovaniya" value="{{ old('otdel_planirovaniya', $uncomfirmed->otdel_planirovaniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_zagryzki') ? 'is-invalid' : '' }}" type="text" name="period_zagryzki" id="period_zagryzki" value="{{ old('period_zagryzki', $uncomfirmed->period_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_razgryzki') ? 'is-invalid' : '' }}" type="text" name="period_razgryzki" id="period_razgryzki" value="{{ old('period_razgryzki', $uncomfirmed->period_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $uncomfirmed->start) }}">
                @if($errors->has('start'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="mesto_naznacheniya" id="mesto_naznacheniya" value="{{ old('mesto_naznacheniya', $uncomfirmed->mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('krainiy_srok') ? 'is-invalid' : '' }}" type="text" name="krainiy_srok" id="krainiy_srok" value="{{ old('krainiy_srok', $uncomfirmed->krainiy_srok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rassoyanie') ? 'is-invalid' : '' }}" type="text" name="rassoyanie" id="rassoyanie" value="{{ old('rassoyanie', $uncomfirmed->rassoyanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sostoyanie_chteniya') ? 'is-invalid' : '' }}" type="text" name="sostoyanie_chteniya" id="sostoyanie_chteniya" value="{{ old('sostoyanie_chteniya', $uncomfirmed->sostoyanie_chteniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sostoyanie_pechati') ? 'is-invalid' : '' }}" type="text" name="sostoyanie_pechati" id="sostoyanie_pechati" value="{{ old('sostoyanie_pechati', $uncomfirmed->sostoyanie_pechati) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transporeonid') ? 'is-invalid' : '' }}" type="text" name="transporeonid" id="transporeonid" value="{{ old('transporeonid', $uncomfirmed->transporeonid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gryzootpravitel') ? 'is-invalid' : '' }}" type="text" name="gryzootpravitel" id="gryzootpravitel" value="{{ old('gryzootpravitel', $uncomfirmed->gryzootpravitel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postavki') ? 'is-invalid' : '' }}" type="text" name="postavki" id="postavki" value="{{ old('postavki', $uncomfirmed->postavki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_pogryzki') ? 'is-invalid' : '' }}" type="text" name="data_pogryzki" id="data_pogryzki" value="{{ old('data_pogryzki', $uncomfirmed->data_pogryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_razgryzki') ? 'is-invalid' : '' }}" type="text" name="data_razgryzki" id="data_razgryzki" value="{{ old('data_razgryzki', $uncomfirmed->data_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poslednie_izmeneniya') ? 'is-invalid' : '' }}" type="text" name="poslednie_izmeneniya" id="poslednie_izmeneniya" value="{{ old('poslednie_izmeneniya', $uncomfirmed->poslednie_izmeneniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opredelennie_mesta_zagryzki') ? 'is-invalid' : '' }}" type="text" name="opredelennie_mesta_zagryzki" id="opredelennie_mesta_zagryzki" value="{{ old('opredelennie_mesta_zagryzki', $uncomfirmed->opredelennie_mesta_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_kompanii_start') ? 'is-invalid' : '' }}" type="text" name="nazvanie_kompanii_start" id="nazvanie_kompanii_start" value="{{ old('nazvanie_kompanii_start', $uncomfirmed->nazvanie_kompanii_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_start') ? 'is-invalid' : '' }}" type="text" name="gorod_start" id="gorod_start" value="{{ old('gorod_start', $uncomfirmed->gorod_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opredelennie_mesta_razgryzki') ? 'is-invalid' : '' }}" type="text" name="opredelennie_mesta_razgryzki" id="opredelennie_mesta_razgryzki" value="{{ old('opredelennie_mesta_razgryzki', $uncomfirmed->opredelennie_mesta_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_kompanii_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="nazvanie_kompanii_mesto_naznacheniya" id="nazvanie_kompanii_mesto_naznacheniya" value="{{ old('nazvanie_kompanii_mesto_naznacheniya', $uncomfirmed->nazvanie_kompanii_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="gorod_mesto_naznacheniya" id="gorod_mesto_naznacheniya" value="{{ old('gorod_mesto_naznacheniya', $uncomfirmed->gorod_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spravochnaya_cena_perevozki') ? 'is-invalid' : '' }}" type="text" name="spravochnaya_cena_perevozki" id="spravochnaya_cena_perevozki" value="{{ old('spravochnaya_cena_perevozki', $uncomfirmed->spravochnaya_cena_perevozki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="region_mesto_naznacheniya" id="region_mesto_naznacheniya" value="{{ old('region_mesto_naznacheniya', $uncomfirmed->region_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="kommentariy_mesto_naznacheniya" id="kommentariy_mesto_naznacheniya" value="{{ old('kommentariy_mesto_naznacheniya', $uncomfirmed->kommentariy_mesto_naznacheniya) }}">
