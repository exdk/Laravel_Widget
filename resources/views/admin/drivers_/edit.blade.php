    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="photodriver">{{ trans('cruds.driver.fields.photodriver') }}</label>
                <div class="needsclick dropzone {{ $errors->has('photodriver') ? 'is-invalid' : '' }}" id="photodriver-dropzone">
                </div>
                @if($errors->has('photodriver'))
                    <span class="text-danger">{{ $errors->first('photodriver') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.driver.fields.photodriver_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="fam">{{ trans('cruds.driver.fields.fam') }}</label>
                <input class="form-control {{ $errors->has('fam') ? 'is-invalid' : '' }}" type="text" name="fam" id="fam" value="{{ old('fam', $driver->fam) }}">
                @if($errors->has('fam'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oth') ? 'is-invalid' : '' }}" type="text" name="oth" id="oth" value="{{ old('oth', $driver->oth) }}">
                @if($errors->has('oth'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $driver->date) }}">
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_place') ? 'is-invalid' : '' }}" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $driver->birth_place) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pa_ty') ? 'is-invalid' : '' }}" type="text" name="pa_ty" id="pa_ty" value="{{ old('pa_ty', $driver->pa_ty) }}">
                @if($errors->has('pa_ty'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pa_nomer') ? 'is-invalid' : '' }}" type="text" name="pa_nomer" id="pa_nomer" value="{{ old('pa_nomer', $driver->pa_nomer) }}">
            ...
            <div class="form-group">
                <label for="pachecked">{{ trans('cruds.driver.fields.pachecked') }}</label>
                <input class="form-control {{ $errors->has('pachecked') ? 'is-invalid' : '' }}" type="text" name="pachecked" id="pachecked" value="{{ old('pachecked', $driver->pachecked) }}">
                @if($errors->has('pachecked'))
                    <span class="text-danger">{{ $errors->first('pachecked') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.driver.fields.pachecked_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="pa_date">{{ trans('cruds.driver.fields.pa_date') }}</label>
                <input class="form-control date {{ $errors->has('pa_date') ? 'is-invalid' : '' }}" type="text" name="pa_date" id="pa_date" value="{{ old('pa_date', $driver->pa_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pa_kod') ? 'is-invalid' : '' }}" type="text" name="pa_kod" id="pa_kod" value="{{ old('pa_kod', $driver->pa_kod) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('pa_by') ? 'is-invalid' : '' }}" name="pa_by" id="pa_by">{{ old('pa_by', $driver->pa_by) }}</textarea>
                @if($errors->has('pa_by'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adr_pro') ? 'is-invalid' : '' }}" type="text" name="adr_pro" id="adr_pro" value="{{ old('adr_pro', $driver->adr_pro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pro_date') ? 'is-invalid' : '' }}" type="text" name="pro_date" id="pro_date" value="{{ old('pro_date', $driver->pro_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pro_vr_adr') ? 'is-invalid' : '' }}" type="text" name="pro_vr_adr" id="pro_vr_adr" value="{{ old('pro_vr_adr', $driver->pro_vr_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pro_vr_date_ot') ? 'is-invalid' : '' }}" type="text" name="pro_vr_date_ot" id="pro_vr_date_ot" value="{{ old('pro_vr_date_ot', $driver->pro_vr_date_ot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pro_vr_date_do') ? 'is-invalid' : '' }}" type="text" name="pro_vr_date_do" id="pro_vr_date_do" value="{{ old('pro_vr_date_do', $driver->pro_vr_date_do) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomervu') ? 'is-invalid' : '' }}" type="text" name="nomervu" id="nomervu" value="{{ old('nomervu', $driver->nomervu) }}">
            ...
            <div class="form-group">
                <label for="vuchecked">{{ trans('cruds.driver.fields.vuchecked') }}</label>
                <input class="form-control {{ $errors->has('vuchecked') ? 'is-invalid' : '' }}" type="text" name="vuchecked" id="vuchecked" value="{{ old('vuchecked', $driver->vuchecked) }}">
                @if($errors->has('vuchecked'))
                    <span class="text-danger">{{ $errors->first('vuchecked') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.driver.fields.vuchecked_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="datevu">{{ trans('cruds.driver.fields.datevu') }}</label>
                <input class="form-control date {{ $errors->has('datevu') ? 'is-invalid' : '' }}" type="text" name="datevu" id="datevu" value="{{ old('datevu', $driver->datevu) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('byvu') ? 'is-invalid' : '' }}" type="text" name="byvu" id="byvu" value="{{ old('byvu', $driver->byvu) }}">
                @if($errors->has('byvu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vu_gorod') ? 'is-invalid' : '' }}" type="text" name="vu_gorod" id="vu_gorod" value="{{ old('vu_gorod', $driver->vu_gorod) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taho') ? 'is-invalid' : '' }}" type="text" name="taho" id="taho" value="{{ old('taho', $driver->taho) }}">
                @if($errors->has('taho'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inn') ? 'is-invalid' : '' }}" type="text" name="inn" id="inn" value="{{ old('inn', $driver->inn) }}">
                @if($errors->has('inn'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pfr') ? 'is-invalid' : '' }}" type="text" name="pfr" id="pfr" value="{{ old('pfr', $driver->pfr) }}">
                @if($errors->has('pfr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $driver->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_a') ? 'is-invalid' : '' }}" type="text" name="mobile_a" id="mobile_a" value="{{ old('mobile_a', $driver->mobile_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_b') ? 'is-invalid' : '' }}" type="text" name="mobile_b" id="mobile_b" value="{{ old('mobile_b', $driver->mobile_b) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('medb_nomer') ? 'is-invalid' : '' }}" type="text" name="medb_nomer" id="medb_nomer" value="{{ old('medb_nomer', $driver->medb_nomer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('medb_typ') ? 'is-invalid' : '' }}" type="text" name="medb_typ" id="medb_typ" value="{{ old('medb_typ', $driver->medb_typ) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('medb_date_ot') ? 'is-invalid' : '' }}" type="text" name="medb_date_ot" id="medb_date_ot" value="{{ old('medb_date_ot', $driver->medb_date_ot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trud_nomer') ? 'is-invalid' : '' }}" type="text" name="trud_nomer" id="trud_nomer" value="{{ old('trud_nomer', $driver->trud_nomer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('trud_date_ot') ? 'is-invalid' : '' }}" type="text" name="trud_date_ot" id="trud_date_ot" value="{{ old('trud_date_ot', $driver->trud_date_ot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trud_dol') ? 'is-invalid' : '' }}" type="text" name="trud_dol" id="trud_dol" value="{{ old('trud_dol', $driver->trud_dol) }}">
...
@section('scripts')
<script>
    Dropzone.options.photodriverDropzone = {
    ...
    success: function (file, response) {
      $('form').find('input[name="photodriver"]').remove()
      $('form').append('<input type="hidden" name="photodriver" value="' + response.name + '">')
    },
    ...
    init: function () {
@if(isset($driver) && $driver->photodriver)
      var file = {!! json_encode($driver->photodriver) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview)
      file.previewElement.classList.add('dz-complete')
      $('form').append('<input type="hidden" name="photodriver" value="' + file.file_name + '">')
      this.options.maxFiles = this.options.maxFiles - 1
@endif
    },
