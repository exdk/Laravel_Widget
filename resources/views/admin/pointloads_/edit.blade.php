...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pointload.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pointloads.update", [$pointload->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="sapid">{{ trans('cruds.pointload.fields.sapid') }}</label>
                <input class="form-control {{ $errors->has('sapid') ? 'is-invalid' : '' }}" type="text" name="sapid" id="sapid" value="{{ old('sapid', $pointload->sapid) }}">
                @if($errors->has('sapid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $pointload->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod') ? 'is-invalid' : '' }}" type="text" name="gorod" id="gorod" value="{{ old('gorod', $pointload->gorod) }}">
                @if($errors->has('gorod'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $pointload->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $pointload->zip) }}">
                @if($errors->has('zip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region') ? 'is-invalid' : '' }}" type="text" name="region" id="region" value="{{ old('region', $pointload->region) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ulitca') ? 'is-invalid' : '' }}" type="text" name="ulitca" id="ulitca" value="{{ old('ulitca', $pointload->ulitca) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dom') ? 'is-invalid' : '' }}" type="text" name="dom" id="dom" value="{{ old('dom', $pointload->dom) }}">
                @if($errors->has('dom'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('komment') ? 'is-invalid' : '' }}" type="text" name="komment" id="komment" value="{{ old('komment', $pointload->komment) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type">
                    ...
                    @foreach(App\Models\Pointload::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', $pointload->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('komuperevozklient') ? 'is-invalid' : '' }}" name="komuperevozklient_id" id="komuperevozklient_id">
                    @foreach($komuperevozklients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('komuperevozklient_id') ? old('komuperevozklient_id') : $pointload->komuperevozklient->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('komuzakazklient') ? 'is-invalid' : '' }}" name="komuzakazklient_id" id="komuzakazklient_id">
                    @foreach($komuzakazklients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('komuzakazklient_id') ? old('komuzakazklient_id') : $pointload->komuzakazklient->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('innfio') ? 'is-invalid' : '' }}" type="text" name="innfio" id="innfio" value="{{ old('innfio', $pointload->innfio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fioload') ? 'is-invalid' : '' }}" type="text" name="fioload" id="fioload" value="{{ old('fioload', $pointload->fioload) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobileload') ? 'is-invalid' : '' }}" type="text" name="mobileload" id="mobileload" value="{{ old('mobileload', $pointload->mobileload) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pnot') ? 'is-invalid' : '' }}" type="text" name="pnot" id="pnot" value="{{ old('pnot', $pointload->pnot) }}">
                @if($errors->has('pnot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pndo') ? 'is-invalid' : '' }}" type="text" name="pndo" id="pndo" value="{{ old('pndo', $pointload->pndo) }}">
                @if($errors->has('pndo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pnbrot') ? 'is-invalid' : '' }}" type="text" name="pnbrot" id="pnbrot" value="{{ old('pnbrot', $pointload->pnbrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pnbrdo') ? 'is-invalid' : '' }}" type="text" name="pnbrdo" id="pnbrdo" value="{{ old('pnbrdo', $pointload->pnbrdo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thot') ? 'is-invalid' : '' }}" type="text" name="thot" id="thot" value="{{ old('thot', $pointload->thot) }}">
                @if($errors->has('thot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thdo') ? 'is-invalid' : '' }}" type="text" name="thdo" id="thdo" value="{{ old('thdo', $pointload->thdo) }}">
                @if($errors->has('thdo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thbrot') ? 'is-invalid' : '' }}" type="text" name="thbrot" id="thbrot" value="{{ old('thbrot', $pointload->thbrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thbrdo') ? 'is-invalid' : '' }}" type="text" name="thbrdo" id="thbrdo" value="{{ old('thbrdo', $pointload->thbrdo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wedot') ? 'is-invalid' : '' }}" type="text" name="wedot" id="wedot" value="{{ old('wedot', $pointload->wedot) }}">
                @if($errors->has('wedot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weddo') ? 'is-invalid' : '' }}" type="text" name="weddo" id="weddo" value="{{ old('weddo', $pointload->weddo) }}">
                @if($errors->has('weddo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wedbrot') ? 'is-invalid' : '' }}" type="text" name="wedbrot" id="wedbrot" value="{{ old('wedbrot', $pointload->wedbrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wedbrto') ? 'is-invalid' : '' }}" type="text" name="wedbrto" id="wedbrto" value="{{ old('wedbrto', $pointload->wedbrto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thuot') ? 'is-invalid' : '' }}" type="text" name="thuot" id="thuot" value="{{ old('thuot', $pointload->thuot) }}">
                @if($errors->has('thuot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thudo') ? 'is-invalid' : '' }}" type="text" name="thudo" id="thudo" value="{{ old('thudo', $pointload->thudo) }}">
                @if($errors->has('thudo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thubrot') ? 'is-invalid' : '' }}" type="text" name="thubrot" id="thubrot" value="{{ old('thubrot', $pointload->thubrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('thubrdo') ? 'is-invalid' : '' }}" type="text" name="thubrdo" id="thubrdo" value="{{ old('thubrdo', $pointload->thubrdo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('friot') ? 'is-invalid' : '' }}" type="text" name="friot" id="friot" value="{{ old('friot', $pointload->friot) }}">
                @if($errors->has('friot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('frido') ? 'is-invalid' : '' }}" type="text" name="frido" id="frido" value="{{ old('frido', $pointload->frido) }}">
                @if($errors->has('frido'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fribrot') ? 'is-invalid' : '' }}" type="text" name="fribrot" id="fribrot" value="{{ old('fribrot', $pointload->fribrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fribrdo') ? 'is-invalid' : '' }}" type="text" name="fribrdo" id="fribrdo" value="{{ old('fribrdo', $pointload->fribrdo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satot') ? 'is-invalid' : '' }}" type="text" name="satot" id="satot" value="{{ old('satot', $pointload->satot) }}">
                @if($errors->has('satot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satdo') ? 'is-invalid' : '' }}" type="text" name="satdo" id="satdo" value="{{ old('satdo', $pointload->satdo) }}">
                @if($errors->has('satdo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satbrot') ? 'is-invalid' : '' }}" type="text" name="satbrot" id="satbrot" value="{{ old('satbrot', $pointload->satbrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satbrdo') ? 'is-invalid' : '' }}" type="text" name="satbrdo" id="satbrdo" value="{{ old('satbrdo', $pointload->satbrdo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sunot') ? 'is-invalid' : '' }}" type="text" name="sunot" id="sunot" value="{{ old('sunot', $pointload->sunot) }}">
                @if($errors->has('sunot'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sundo') ? 'is-invalid' : '' }}" type="text" name="sundo" id="sundo" value="{{ old('sundo', $pointload->sundo) }}">
                @if($errors->has('sundo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sunbrot') ? 'is-invalid' : '' }}" type="text" name="sunbrot" id="sunbrot" value="{{ old('sunbrot', $pointload->sunbrot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sunbrdo') ? 'is-invalid' : '' }}" type="text" name="sunbrdo" id="sunbrdo" value="{{ old('sunbrdo', $pointload->sunbrdo) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('holiday') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="holiday" id="holiday" value="1" {{ $pointload->holiday || old('holiday', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="text" name="lat" id="lat" value="{{ old('lat', $pointload->lat) }}">
                @if($errors->has('lat'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('long') ? 'is-invalid' : '' }}" type="text" name="long" id="long" value="{{ old('long', $pointload->long) }}">
                @if($errors->has('long'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('holidaylis') ? 'is-invalid' : '' }}" name="holidaylis[]" id="holidaylis" multiple>
                    @foreach($holidaylis as $id => $holidayli)
                        <option value="{{ $id }}" {{ (in_array($id, old('holidaylis', [])) || $pointload->holidaylis->contains($id)) ? 'selected' : '' }}>{{ $holidayli }}</option>
                    @endforeach
                </select>
