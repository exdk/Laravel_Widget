...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">Чаты</span> </a>
                {{-- header buttons --}}
            ...
            <div class="messenger-listView-tabs">
                ...
                <a href="#" @if($type == 'group') class="active-tab" @endif data-view="groups">
                    <span class="fas fa-users"></span> Группы</a>
            </div>
        </div>
        {{-- tabs and lists --}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">Отсутствует соединение с интернетом</span>
        </div>
        {{-- Messaging area --}}
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Пожалуйста, выберите чат для начала общения</span></p>
            </div>
            {{-- Typing indicator --}}
