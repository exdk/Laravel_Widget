        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.update") }}">
                    @csrf
                    <div class="form-group">
                        <label class="required" for="password">Новый {{ trans('cruds.user.fields.password') }}</label>
                    ...
                    <div class="form-group">
                        <label class="required" for="password_confirmation">Повторить новый {{ trans('cruds.user.fields.password') }}</label>
