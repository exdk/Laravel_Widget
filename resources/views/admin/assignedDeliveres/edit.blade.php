...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.assignedDelivere.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.assigned-deliveres.update", [$assignedDelivere->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="deliveryid">{{ trans('cruds.assignedDelivere.fields.deliveryid') }}</label>
                <input class="form-control {{ $errors->has('deliveryid') ? 'is-invalid' : '' }}" type="text" name="deliveryid" id="deliveryid" value="{{ old('deliveryid', $assignedDelivere->deliveryid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statusi_razmestit_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statusi_razmestit_otslezhivanie_gryza" id="statusi_razmestit_otslezhivanie_gryza" value="{{ old('statusi_razmestit_otslezhivanie_gryza', $assignedDelivere->statusi_razmestit_otslezhivanie_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_postavki') ? 'is-invalid' : '' }}" type="text" name="n_postavki" id="n_postavki" value="{{ old('n_postavki', $assignedDelivere->n_postavki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_postavki') ? 'is-invalid' : '' }}" type="text" name="id_postavki" id="id_postavki" value="{{ old('id_postavki', $assignedDelivere->id_postavki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_perevozki') ? 'is-invalid' : '' }}" type="text" name="n_perevozki" id="n_perevozki" value="{{ old('n_perevozki', $assignedDelivere->n_perevozki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_naznacheniya_yroven_perevozki') ? 'is-invalid' : '' }}" type="text" name="data_naznacheniya_yroven_perevozki" id="data_naznacheniya_yroven_perevozki" value="{{ old('data_naznacheniya_yroven_perevozki', $assignedDelivere->data_naznacheniya_yroven_perevozki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gryzootpravitel') ? 'is-invalid' : '' }}" type="text" name="gryzootpravitel" id="gryzootpravitel" value="{{ old('gryzootpravitel', $assignedDelivere->gryzootpravitel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eta') ? 'is-invalid' : '' }}" type="text" name="eta" id="eta" value="{{ old('eta', $assignedDelivere->eta) }}">
                @if($errors->has('eta'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_eta') ? 'is-invalid' : '' }}" type="text" name="statys_eta" id="statys_eta" value="{{ old('statys_eta', $assignedDelivere->statys_eta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('raznitsa_s_eta') ? 'is-invalid' : '' }}" type="text" name="raznitsa_s_eta" id="raznitsa_s_eta" value="{{ old('raznitsa_s_eta', $assignedDelivere->raznitsa_s_eta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eta_tip') ? 'is-invalid' : '' }}" type="text" name="eta_tip" id="eta_tip" value="{{ old('eta_tip', $assignedDelivere->eta_tip) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_kompanii_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="nazvanie_kompanii_mesto_zagryzki" id="nazvanie_kompanii_mesto_zagryzki" value="{{ old('nazvanie_kompanii_mesto_zagryzki', $assignedDelivere->nazvanie_kompanii_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelnie_dannie_adresa_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="dopolnitelnie_dannie_adresa_mesto_zagryzki" id="dopolnitelnie_dannie_adresa_mesto_zagryzki" value="{{ old('dopolnitelnie_dannie_adresa_mesto_zagryzki', $assignedDelivere->dopolnitelnie_dannie_adresa_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ylitsa_i_nom_doma_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="ylitsa_i_nom_doma_mesto_zagryzki" id="ylitsa_i_nom_doma_mesto_zagryzki" value="{{ old('ylitsa_i_nom_doma_mesto_zagryzki', $assignedDelivere->ylitsa_i_nom_doma_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pochtoviy_indeks_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="pochtoviy_indeks_mesto_zagryzki" id="pochtoviy_indeks_mesto_zagryzki" value="{{ old('pochtoviy_indeks_mesto_zagryzki', $assignedDelivere->pochtoviy_indeks_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="gorod_mesto_zagryzki" id="gorod_mesto_zagryzki" value="{{ old('gorod_mesto_zagryzki', $assignedDelivere->gorod_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="region_mesto_zagryzki" id="region_mesto_zagryzki" value="{{ old('region_mesto_zagryzki', $assignedDelivere->region_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strana_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="strana_mesto_zagryzki" id="strana_mesto_zagryzki" value="{{ old('strana_mesto_zagryzki', $assignedDelivere->strana_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_telefona_dlya_avizo_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="nomer_telefona_dlya_avizo_mesto_zagryzki" id="nomer_telefona_dlya_avizo_mesto_zagryzki" value="{{ old('nomer_telefona_dlya_avizo_mesto_zagryzki', $assignedDelivere->nomer_telefona_dlya_avizo_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_mesto_zagryzki') ? 'is-invalid' : '' }}" type="text" name="kommentariy_mesto_zagryzki" id="kommentariy_mesto_zagryzki" value="{{ old('kommentariy_mesto_zagryzki', $assignedDelivere->kommentariy_mesto_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_zagryzki_ot') ? 'is-invalid' : '' }}" type="text" name="data_zagryzki_ot" id="data_zagryzki_ot" value="{{ old('data_zagryzki_ot', $assignedDelivere->data_zagryzki_ot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_zagryzki_do') ? 'is-invalid' : '' }}" type="text" name="data_zagryzki_do" id="data_zagryzki_do" value="{{ old('data_zagryzki_do', $assignedDelivere->data_zagryzki_do) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_kompanii_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="nazvanie_kompanii_mesto_razgryzki" id="nazvanie_kompanii_mesto_razgryzki" value="{{ old('nazvanie_kompanii_mesto_razgryzki', $assignedDelivere->nazvanie_kompanii_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelnie_dannie_adesa_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="dopolnitelnie_dannie_adesa_mesto_razgryzki" id="dopolnitelnie_dannie_adesa_mesto_razgryzki" value="{{ old('dopolnitelnie_dannie_adesa_mesto_razgryzki', $assignedDelivere->dopolnitelnie_dannie_adesa_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ylitsa_i_nom_doma_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="ylitsa_i_nom_doma_mesto_razgryzki" id="ylitsa_i_nom_doma_mesto_razgryzki" value="{{ old('ylitsa_i_nom_doma_mesto_razgryzki', $assignedDelivere->ylitsa_i_nom_doma_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pochtoviy_indeks_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="pochtoviy_indeks_mesto_razgryzki" id="pochtoviy_indeks_mesto_razgryzki" value="{{ old('pochtoviy_indeks_mesto_razgryzki', $assignedDelivere->pochtoviy_indeks_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="gorod_mesto_razgryzki" id="gorod_mesto_razgryzki" value="{{ old('gorod_mesto_razgryzki', $assignedDelivere->gorod_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="region_mesto_razgryzki" id="region_mesto_razgryzki" value="{{ old('region_mesto_razgryzki', $assignedDelivere->region_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_telefona_dlya_avizo_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="nomer_telefona_dlya_avizo_mesto_razgryzki" id="nomer_telefona_dlya_avizo_mesto_razgryzki" value="{{ old('nomer_telefona_dlya_avizo_mesto_razgryzki', $assignedDelivere->nomer_telefona_dlya_avizo_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_mesto_razgryzki') ? 'is-invalid' : '' }}" type="text" name="kommentariy_mesto_razgryzki" id="kommentariy_mesto_razgryzki" value="{{ old('kommentariy_mesto_razgryzki', $assignedDelivere->kommentariy_mesto_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_razgryzki_ot') ? 'is-invalid' : '' }}" type="text" name="data_razgryzki_ot" id="data_razgryzki_ot" value="{{ old('data_razgryzki_ot', $assignedDelivere->data_razgryzki_ot) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_razgryzki_do') ? 'is-invalid' : '' }}" type="text" name="data_razgryzki_do" id="data_razgryzki_do" value="{{ old('data_razgryzki_do', $assignedDelivere->data_razgryzki_do) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inkotermsi') ? 'is-invalid' : '' }}" type="text" name="inkotermsi" id="inkotermsi" value="{{ old('inkotermsi', $assignedDelivere->inkotermsi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inkoterms_gorod') ? 'is-invalid' : '' }}" type="text" name="inkoterms_gorod" id="inkoterms_gorod" value="{{ old('inkoterms_gorod', $assignedDelivere->inkoterms_gorod) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ves') ? 'is-invalid' : '' }}" type="number" name="ves" id="ves" value="{{ old('ves', $assignedDelivere->ves) }}" step="0.01">
                @if($errors->has('ves'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obem') ? 'is-invalid' : '' }}" type="number" name="obem" id="obem" value="{{ old('obem', $assignedDelivere->obem) }}" step="0.01">
                @if($errors->has('obem'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edinitsa_vesa') ? 'is-invalid' : '' }}" type="text" name="edinitsa_vesa" id="edinitsa_vesa" value="{{ old('edinitsa_vesa', $assignedDelivere->edinitsa_vesa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edinitsa_obema') ? 'is-invalid' : '' }}" type="text" name="edinitsa_obema" id="edinitsa_obema" value="{{ old('edinitsa_obema', $assignedDelivere->edinitsa_obema) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dlina') ? 'is-invalid' : '' }}" type="number" name="dlina" id="dlina" value="{{ old('dlina', $assignedDelivere->dlina) }}" step="0.01">
                @if($errors->has('dlina'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edinitsa_dlini') ? 'is-invalid' : '' }}" type="text" name="edinitsa_dlini" id="edinitsa_dlini" value="{{ old('edinitsa_dlini', $assignedDelivere->edinitsa_dlini) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pozichii') ? 'is-invalid' : '' }}" type="text" name="pozichii" id="pozichii" value="{{ old('pozichii', $assignedDelivere->pozichii) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transportnoe_sredstvo_trebovanie') ? 'is-invalid' : '' }}" type="text" name="transportnoe_sredstvo_trebovanie" id="transportnoe_sredstvo_trebovanie" value="{{ old('transportnoe_sredstvo_trebovanie', $assignedDelivere->transportnoe_sredstvo_trebovanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registratsionniy_n') ? 'is-invalid' : '' }}" type="text" name="registratsionniy_n" id="registratsionniy_n" value="{{ old('registratsionniy_n', $assignedDelivere->registratsionniy_n) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transportnie_edinitsi') ? 'is-invalid' : '' }}" type="text" name="transportnie_edinitsi" id="transportnie_edinitsi" value="{{ old('transportnie_edinitsi', $assignedDelivere->transportnie_edinitsi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transpostnaya_edinitsa') ? 'is-invalid' : '' }}" type="text" name="transpostnaya_edinitsa" id="transpostnaya_edinitsa" value="{{ old('transpostnaya_edinitsa', $assignedDelivere->transpostnaya_edinitsa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('klass_opasnih_gryzov_opasnie_gryzi_n') ? 'is-invalid' : '' }}" type="text" name="klass_opasnih_gryzov_opasnie_gryzi_n" id="klass_opasnih_gryzov_opasnie_gryzi_n" value="{{ old('klass_opasnih_gryzov_opasnie_gryzi_n', $assignedDelivere->klass_opasnih_gryzov_opasnie_gryzi_n) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_k_postavke') ? 'is-invalid' : '' }}" type="text" name="kommentariy_k_postavke" id="kommentariy_k_postavke" value="{{ old('kommentariy_k_postavke', $assignedDelivere->kommentariy_k_postavke) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_yroven_postavki_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statys_yroven_postavki_otslezhivanie_gryza" id="statys_yroven_postavki_otslezhivanie_gryza" value="{{ old('statys_yroven_postavki_otslezhivanie_gryza', $assignedDelivere->statys_yroven_postavki_otslezhivanie_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('statys_statys_data_yroven_postavki_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statys_statys_data_yroven_postavki_otslezhivanie_gryza" id="statys_statys_data_yroven_postavki_otslezhivanie_gryza" value="{{ old('statys_statys_data_yroven_postavki_otslezhivanie_gryza', $assignedDelivere->statys_statys_data_yroven_postavki_otslezhivanie_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_kem_razmescheno_yroven_postavki_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statys_kem_razmescheno_yroven_postavki_otslezhivanie_gryza" id="statys_kem_razmescheno_yroven_postavki_otslezhivanie_gryza" value="{{ old('statys_kem_razmescheno_yroven_postavki_otslezhivanie_gryza', $assignedDelivere->statys_kem_razmescheno_yroven_postavki_otslezhivanie_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_kommentariy_yroven_postavki_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statys_kommentariy_yroven_postavki_otslezhivanie_gryza" id="statys_kommentariy_yroven_postavki_otslezhivanie_gryza" value="{{ old('statys_kommentariy_yroven_postavki_otslezhivanie_gryza', $assignedDelivere->statys_kommentariy_yroven_postavki_otslezhivanie_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vlozheniya') ? 'is-invalid' : '' }}" type="text" name="vlozheniya" id="vlozheniya" value="{{ old('vlozheniya', $assignedDelivere->vlozheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poslednie_izmeneniya') ? 'is-invalid' : '' }}" type="text" name="poslednie_izmeneniya" id="poslednie_izmeneniya" value="{{ old('poslednie_izmeneniya', $assignedDelivere->poslednie_izmeneniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transporeon_id_yroven_perevozki') ? 'is-invalid' : '' }}" type="text" name="transporeon_id_yroven_perevozki" id="transporeon_id_yroven_perevozki" value="{{ old('transporeon_id_yroven_perevozki', $assignedDelivere->transporeon_id_yroven_perevozki) }}">
