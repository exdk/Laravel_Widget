    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-pointloadZakaznagruzs">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.perez') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_1_t') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_1_tot') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_1_val') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_1_typ') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_1_tam') }}
                            </th>
                            <th>
                                {{ trans('cruds.custom.fields.address') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_t') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_adr') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_tot') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_val') }}
                            </th>
                            <th>
                                {{ trans('cruds.valutum.fields.code_2') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_typ') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_2_tam') }}
                            </th>
                            <th>
                                {{ trans('cruds.custom.fields.title') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_t') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_adr') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_tot') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_val') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_typ') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_3_tam') }}
                            </th>
                            <th>
                                {{ trans('cruds.custom.fields.title') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_t') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_adr') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_tot') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_val') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_typ') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_4_tam') }}
                            </th>
                            <th>
                                {{ trans('cruds.custom.fields.title') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_t') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_adr') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_tot') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_val') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_typ') }}
                            </th>
                            <th>
                                {{ trans('cruds.zakaznagruz.fields.dop_5_tam') }}
                            </th>
                            <th>
                                {{ trans('cruds.custom.fields.title') }}
                            </th>
                    ...
                    <tbody>
                        @foreach($zakaznagruzs as $key => $zakaznagruz)
                            <tr data-entry-id="{{ $zakaznagruz->id }}">
                                ...
                                <td>
                                    {{ App\Models\Zakaznagruz::PEREZ_SELECT[$zakaznagruz->perez] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->look ?? '' }}
                                </td>
                                ...
                                <td>
                                    {{ App\Models\Zakaznagruz::DOP_1_T_RADIO[$zakaznagruz->dop_1_t] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_1_tot ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_1_val->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_1_typ->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_1_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_1_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\Zakaznagruz::DOP_2_T_RADIO[$zakaznagruz->dop_2_t] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_adr ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_tot ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_val->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_val->code_2 ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_typ->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_2_tam->title ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\Zakaznagruz::DOP_3_T_RADIO[$zakaznagruz->dop_3_t] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_adr ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_tot ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_val->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_typ->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_3_tam->title ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\Zakaznagruz::DOP_4_T_RADIO[$zakaznagruz->dop_4_t] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_adr ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_tot ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_val->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_typ->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_4_tam->title ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\Zakaznagruz::DOP_5_T_RADIO[$zakaznagruz->dop_5_t] ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_adr ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_tot ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_val->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_typ->title ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_tam->address ?? '' }}
                                </td>
                                <td>
                                    {{ $zakaznagruz->dop_5_tam->title ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-pointloadZakaznagruzs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
