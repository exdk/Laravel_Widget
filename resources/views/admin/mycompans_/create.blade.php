...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mycompan.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mycompans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefonorg') ? 'is-invalid' : '' }}" type="text" name="telefonorg" id="telefonorg" value="{{ old('telefonorg', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('orgmobile') ? 'is-invalid' : '' }}" type="text" name="orgmobile" id="orgmobile" value="{{ old('orgmobile', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bik') ? 'is-invalid' : '' }}" type="text" name="bik" id="bik" value="{{ old('bik', '') }}">
                @if($errors->has('bik'))
