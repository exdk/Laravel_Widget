...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.auto.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.autos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('govnomer') ? 'is-invalid' : '' }}" type="text" name="govnomer" id="govnomer" value="{{ old('govnomer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pt_type') ? 'is-invalid' : '' }}" type="text" name="pt_type" id="pt_type" value="{{ old('pt_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pt_nomer') ? 'is-invalid' : '' }}" type="text" name="pt_nomer" id="pt_nomer" value="{{ old('pt_nomer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ob_type') ? 'is-invalid' : '' }}" type="text" name="ob_type" id="ob_type" value="{{ old('ob_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('op_nemer') ? 'is-invalid' : '' }}" type="text" name="op_nemer" id="op_nemer" value="{{ old('op_nemer', '') }}">
