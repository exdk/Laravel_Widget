...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.listproduct.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.listproducts.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="id_vnutr">{{ trans('cruds.listproduct.fields.id_vnutr') }}</label>
                <input class="form-control {{ $errors->has('id_vnutr') ? 'is-invalid' : '' }}" type="text" name="id_vnutr" id="id_vnutr" value="{{ old('id_vnutr', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unitcount') ? 'is-invalid' : '' }}" type="text" name="unitcount" id="unitcount" value="{{ old('unitcount', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('type_pack_tr') ? 'is-invalid' : '' }}" name="type_pack_tr_id" id="type_pack_tr_id">
                    @foreach($type_pack_trs as $id => $entry)
                        <option value="{{ $id }}" {{ old('type_pack_tr_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tr_quan') ? 'is-invalid' : '' }}" type="text" name="tr_quan" id="tr_quan" value="{{ old('tr_quan', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('type_pal') ? 'is-invalid' : '' }}" name="type_pal_id" id="type_pal_id">
                    @foreach($type_pals as $id => $entry)
                        <option value="{{ $id }}" {{ old('type_pal_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qua_pal') ? 'is-invalid' : '' }}" type="text" name="qua_pal" id="qua_pal" value="{{ old('qua_pal', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_quant') ? 'is-invalid' : '' }}" type="text" name="total_quant" id="total_quant" value="{{ old('total_quant', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_weight') ? 'is-invalid' : '' }}" type="text" name="total_weight" id="total_weight" value="{{ old('total_weight', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_sum') ? 'is-invalid' : '' }}" type="text" name="total_sum" id="total_sum" value="{{ old('total_sum', '') }}">
