...
@can('auto_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.autos.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.auto.title_singular') }}
            </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.auto.title_singular') }} {{ trans('global.list') }}
    </div>
