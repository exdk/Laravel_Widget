...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.offering.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.offerings.update", [$offering->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="date_first_load">{{ trans('cruds.offering.fields.date_first_load') }}</label>
                <input class="form-control date {{ $errors->has('date_first_load') ? 'is-invalid' : '' }}" type="text" name="date_first_load" id="date_first_load" value="{{ old('date_first_load', $offering->date_first_load) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transporeonid') ? 'is-invalid' : '' }}" type="text" name="transporeonid" id="transporeonid" value="{{ old('transporeonid', $offering->transporeonid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('neobhodimie_perevozki') ? 'is-invalid' : '' }}" type="text" name="neobhodimie_perevozki" id="neobhodimie_perevozki" value="{{ old('neobhodimie_perevozki', $offering->neobhodimie_perevozki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('procent_kvoti_vipolneno') ? 'is-invalid' : '' }}" type="text" name="procent_kvoti_vipolneno" id="procent_kvoti_vipolneno" value="{{ old('procent_kvoti_vipolneno', $offering->procent_kvoti_vipolneno) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poslednie_izmeneniya') ? 'is-invalid' : '' }}" type="text" name="poslednie_izmeneniya" id="poslednie_izmeneniya" value="{{ old('poslednie_izmeneniya', $offering->poslednie_izmeneniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opredelennie_mesta_zagryzki') ? 'is-invalid' : '' }}" type="text" name="opredelennie_mesta_zagryzki" id="opredelennie_mesta_zagryzki" value="{{ old('opredelennie_mesta_zagryzki', $offering->opredelennie_mesta_zagryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poctoviy_indeks_start') ? 'is-invalid' : '' }}" type="text" name="poctoviy_indeks_start" id="poctoviy_indeks_start" value="{{ old('poctoviy_indeks_start', $offering->poctoviy_indeks_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_start') ? 'is-invalid' : '' }}" type="text" name="region_start" id="region_start" value="{{ old('region_start', $offering->region_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strana_start') ? 'is-invalid' : '' }}" type="text" name="strana_start" id="strana_start" value="{{ old('strana_start', $offering->strana_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_start') ? 'is-invalid' : '' }}" type="text" name="kommentariy_start" id="kommentariy_start" value="{{ old('kommentariy_start', $offering->kommentariy_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opredelennie_mesta_razgryzki') ? 'is-invalid' : '' }}" type="text" name="opredelennie_mesta_razgryzki" id="opredelennie_mesta_razgryzki" value="{{ old('opredelennie_mesta_razgryzki', $offering->opredelennie_mesta_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poctoviy_indeks_mesto_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="poctoviy_indeks_mesto_naznaceniya" id="poctoviy_indeks_mesto_naznaceniya" value="{{ old('poctoviy_indeks_mesto_naznaceniya', $offering->poctoviy_indeks_mesto_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strana_mesto_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="strana_mesto_naznaceniya" id="strana_mesto_naznaceniya" value="{{ old('strana_mesto_naznaceniya', $offering->strana_mesto_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentariy_mesto_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="kommentariy_mesto_naznaceniya" id="kommentariy_mesto_naznaceniya" value="{{ old('kommentariy_mesto_naznaceniya', $offering->kommentariy_mesto_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('predlozheniya') ? 'is-invalid' : '' }}" type="text" name="predlozheniya" id="predlozheniya" value="{{ old('predlozheniya', $offering->predlozheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('predlozhenie') ? 'is-invalid' : '' }}" type="text" name="predlozhenie" id="predlozhenie" value="{{ old('predlozhenie', $offering->predlozhenie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip_predlozheniya') ? 'is-invalid' : '' }}" type="text" name="tip_predlozheniya" id="tip_predlozheniya" value="{{ old('tip_predlozheniya', $offering->tip_predlozheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('deystvitelno_do') ? 'is-invalid' : '' }}" type="text" name="deystvitelno_do" id="deystvitelno_do" value="{{ old('deystvitelno_do', $offering->deystvitelno_do) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kommentarii_k_predlozheniyu') ? 'is-invalid' : '' }}" type="text" name="kommentarii_k_predlozheniyu" id="kommentarii_k_predlozheniyu" value="{{ old('kommentarii_k_predlozheniyu', $offering->kommentarii_k_predlozheniyu) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transportnoe_sredstvo_trebovanie') ? 'is-invalid' : '' }}" type="text" name="transportnoe_sredstvo_trebovanie" id="transportnoe_sredstvo_trebovanie" value="{{ old('transportnoe_sredstvo_trebovanie', $offering->transportnoe_sredstvo_trebovanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ves') ? 'is-invalid' : '' }}" type="text" name="ves" id="ves" value="{{ old('ves', $offering->ves) }}">
                @if($errors->has('ves'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obem') ? 'is-invalid' : '' }}" type="text" name="obem" id="obem" value="{{ old('obem', $offering->obem) }}">
                @if($errors->has('obem'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dlina') ? 'is-invalid' : '' }}" type="text" name="dlina" id="dlina" value="{{ old('dlina', $offering->dlina) }}">
                @if($errors->has('dlina'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pozicii') ? 'is-invalid' : '' }}" type="text" name="pozicii" id="pozicii" value="{{ old('pozicii', $offering->pozicii) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnutrenniy_kommentariy_k_perevozke') ? 'is-invalid' : '' }}" type="text" name="vnutrenniy_kommentariy_k_perevozke" id="vnutrenniy_kommentariy_k_perevozke" value="{{ old('vnutrenniy_kommentariy_k_perevozke', $offering->vnutrenniy_kommentariy_k_perevozke) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_gryppi_perevozok') ? 'is-invalid' : '' }}" type="text" name="id_gryppi_perevozok" id="id_gryppi_perevozok" value="{{ old('id_gryppi_perevozok', $offering->id_gryppi_perevozok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelnie_nomera_gryzootpravitelya') ? 'is-invalid' : '' }}" type="text" name="dopolnitelnie_nomera_gryzootpravitelya" id="dopolnitelnie_nomera_gryzootpravitelya" value="{{ old('dopolnitelnie_nomera_gryzootpravitelya', $offering->dopolnitelnie_nomera_gryzootpravitelya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sposob_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="sposob_naznaceniya" id="sposob_naznaceniya" value="{{ old('sposob_naznaceniya', $offering->sposob_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelniy_n_gryzootpravitelya_2') ? 'is-invalid' : '' }}" type="text" name="dopolnitelniy_n_gryzootpravitelya_2" id="dopolnitelniy_n_gryzootpravitelya_2" value="{{ old('dopolnitelniy_n_gryzootpravitelya_2', $offering->dopolnitelniy_n_gryzootpravitelya_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelniy_n_gryzootpravitelya_3') ? 'is-invalid' : '' }}" type="text" name="dopolnitelniy_n_gryzootpravitelya_3" id="dopolnitelniy_n_gryzootpravitelya_3" value="{{ old('dopolnitelniy_n_gryzootpravitelya_3', $offering->dopolnitelniy_n_gryzootpravitelya_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rassoyanie') ? 'is-invalid' : '' }}" type="text" name="rassoyanie" id="rassoyanie" value="{{ old('rassoyanie', $offering->rassoyanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otdel_planirovaniya') ? 'is-invalid' : '' }}" type="text" name="otdel_planirovaniya" id="otdel_planirovaniya" value="{{ old('otdel_planirovaniya', $offering->otdel_planirovaniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_zagruzki') ? 'is-invalid' : '' }}" type="text" name="period_zagruzki" id="period_zagruzki" value="{{ old('period_zagruzki', $offering->period_zagruzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period_razgruzki') ? 'is-invalid' : '' }}" type="text" name="period_razgruzki" id="period_razgruzki" value="{{ old('period_razgruzki', $offering->period_razgruzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolonka') ? 'is-invalid' : '' }}" type="text" name="kolonka" id="kolonka" value="{{ old('kolonka', $offering->kolonka) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $offering->start) }}">
                @if($errors->has('start'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mesto_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="mesto_naznaceniya" id="mesto_naznaceniya" value="{{ old('mesto_naznaceniya', $offering->mesto_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sostoyanie_chteniya') ? 'is-invalid' : '' }}" type="text" name="sostoyanie_chteniya" id="sostoyanie_chteniya" value="{{ old('sostoyanie_chteniya', $offering->sostoyanie_chteniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sostoyanie_pechati') ? 'is-invalid' : '' }}" type="text" name="sostoyanie_pechati" id="sostoyanie_pechati" value="{{ old('sostoyanie_pechati', $offering->sostoyanie_pechati) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_pogruzki') ? 'is-invalid' : '' }}" type="text" name="data_pogruzki" id="data_pogruzki" value="{{ old('data_pogruzki', $offering->data_pogruzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_razgryzki') ? 'is-invalid' : '' }}" type="text" name="data_razgryzki" id="data_razgryzki" value="{{ old('data_razgryzki', $offering->data_razgryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('krainiy_srok') ? 'is-invalid' : '' }}" type="text" name="krainiy_srok" id="krainiy_srok" value="{{ old('krainiy_srok', $offering->krainiy_srok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_start') ? 'is-invalid' : '' }}" type="text" name="gorod_start" id="gorod_start" value="{{ old('gorod_start', $offering->gorod_start) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_kompanii_mesto_naznaceniya') ? 'is-invalid' : '' }}" type="text" name="nazvanie_kompanii_mesto_naznaceniya" id="nazvanie_kompanii_mesto_naznaceniya" value="{{ old('nazvanie_kompanii_mesto_naznaceniya', $offering->nazvanie_kompanii_mesto_naznaceniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spravochnaya_cena_perevozki') ? 'is-invalid' : '' }}" type="text" name="spravochnaya_cena_perevozki" id="spravochnaya_cena_perevozki" value="{{ old('spravochnaya_cena_perevozki', $offering->spravochnaya_cena_perevozki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('distetcher_gryzootpravitelya') ? 'is-invalid' : '' }}" type="text" name="distetcher_gryzootpravitelya" id="distetcher_gryzootpravitelya" value="{{ old('distetcher_gryzootpravitelya', $offering->distetcher_gryzootpravitelya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kategorii') ? 'is-invalid' : '' }}" type="text" name="kategorii" id="kategorii" value="{{ old('kategorii', $offering->kategorii) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region_mesto_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="region_mesto_naznacheniya" id="region_mesto_naznacheniya" value="{{ old('region_mesto_naznacheniya', $offering->region_mesto_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dispetcher_perevozchika') ? 'is-invalid' : '' }}" type="text" name="dispetcher_perevozchika" id="dispetcher_perevozchika" value="{{ old('dispetcher_perevozchika', $offering->dispetcher_perevozchika) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gryzootpravitel') ? 'is-invalid' : '' }}" type="text" name="gryzootpravitel" id="gryzootpravitel" value="{{ old('gryzootpravitel', $offering->gryzootpravitel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postavki') ? 'is-invalid' : '' }}" type="text" name="postavki" id="postavki" value="{{ old('postavki', $offering->postavki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('naznachennie_perevozki') ? 'is-invalid' : '' }}" type="text" name="naznachennie_perevozki" id="naznachennie_perevozki" value="{{ old('naznachennie_perevozki', $offering->naznachennie_perevozki) }}">
