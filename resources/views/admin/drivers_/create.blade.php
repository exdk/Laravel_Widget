    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drivers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pa_ty') ? 'is-invalid' : '' }}" type="text" name="pa_ty" id="pa_ty" value="{{ old('pa_ty', '') }}">
                @if($errors->has('pa_ty'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pa_nomer') ? 'is-invalid' : '' }}" type="text" name="pa_nomer" id="pa_nomer" value="{{ old('pa_nomer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pachecked') ? 'is-invalid' : '' }}" type="text" name="pachecked" id="pachecked" value="{{ old('pachecked', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('pa_by') ? 'is-invalid' : '' }}" name="pa_by" id="pa_by">{{ old('pa_by') }}</textarea>
                @if($errors->has('pa_by'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomervu') ? 'is-invalid' : '' }}" type="text" name="nomervu" id="nomervu" value="{{ old('nomervu', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vuchecked') ? 'is-invalid' : '' }}" type="text" name="vuchecked" id="vuchecked" value="{{ old('vuchecked', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pfr') ? 'is-invalid' : '' }}" type="text" name="pfr" id="pfr" value="{{ old('pfr', '') }}">
                @if($errors->has('pfr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_a') ? 'is-invalid' : '' }}" type="text" name="mobile_a" id="mobile_a" value="{{ old('mobile_a', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_b') ? 'is-invalid' : '' }}" type="text" name="mobile_b" id="mobile_b" value="{{ old('mobile_b', '') }}">
