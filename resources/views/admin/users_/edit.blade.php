    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $user->surname) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('oth') ? 'is-invalid' : '' }}" type="text" name="oth" id="oth" value="{{ old('oth', $user->oth) }}">
                @if($errors->has('oth'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('firma') ? 'is-invalid' : '' }}" name="firma_id" id="firma_id">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dolgno') ? 'is-invalid' : '' }}" name="dolgno_id" id="dolgno_id">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pfr') ? 'is-invalid' : '' }}" type="text" name="pfr" id="pfr" value="{{ old('pfr', $user->pfr) }}">
                @if($errors->has('pfr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emailto') ? 'is-invalid' : '' }}" type="email" name="emailto" id="emailto" value="{{ old('emailto', $user->emailto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icq') ? 'is-invalid' : '' }}" type="text" name="icq" id="icq" value="{{ old('icq', $user->icq) }}">
                @if($errors->has('icq'))
