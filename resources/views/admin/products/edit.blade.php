    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_pricelist') ? 'is-invalid' : '' }}" type="text" name="nomer_pricelist" id="nomer_pricelist" value="{{ old('nomer_pricelist', $product->nomer_pricelist) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('articel') ? 'is-invalid' : '' }}" type="text" name="articel" id="articel" value="{{ old('articel', $product->articel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $product->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_izm') ? 'is-invalid' : '' }}" type="text" name="unit_izm" id="unit_izm" value="{{ old('unit_izm', $product->unit_izm) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_pack') ? 'is-invalid' : '' }}" type="text" name="type_pack" id="type_pack" value="{{ old('type_pack', $product->type_pack) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="text" name="weight" id="weight" value="{{ old('weight', $product->weight) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_decalaration') ? 'is-invalid' : '' }}" type="text" name="nomer_decalaration" id="nomer_decalaration" value="{{ old('nomer_decalaration', $product->nomer_decalaration) }}">
