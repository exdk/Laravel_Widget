...
<div style="margin-bottom: 10px;display:none;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.drivers.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.driver.title') }}
            </a>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="col-lg-6">
            <a style="float:right;" class="btn btn-success" href="{{ route('admin.drivers.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.driver.title') }}
            </a>
            <button style="float:right;display:none;" class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'Driver', 'route' => 'admin.drivers.parseCsvImport'])
        </div></div>
                    ...
                    @foreach($drivers as $key => $driver)
                        <tr data-entry-id="{{ $driver->id }}">
                            ...
                            <a href="{{ route('admin.drivers.show', $driver->id) }}">
                                {{ $driver->fam ?? '' }} {{ $driver->name ?? '' }} {{ $driver->oth ?? '' }}
                            </a>
                            </td>
                            <td style="display:none;">
                                {{ $driver->name ?? '' }}
