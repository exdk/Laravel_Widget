    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.zakaznagruzs.update", [$zakaznagruz->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DRAFT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('draft') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="draft_{{ $key }}" name="draft" value="{{ $key }}" {{ old('draft', $zakaznagruz->draft) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kubatura') ? 'is-invalid' : '' }}" type="number" name="kubatura" id="kubatura" value="{{ old('kubatura', $zakaznagruz->kubatura) }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('idcomp') ? 'is-invalid' : '' }}" type="text" name="idcomp" id="idcomp" value="{{ old('idcomp', $zakaznagruz->idcomp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iduser') ? 'is-invalid' : '' }}" type="text" name="iduser" id="iduser" value="{{ old('iduser', $zakaznagruz->iduser) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('perez') ? 'is-invalid' : '' }}" name="perez" id="perez">
                    ...
                    @foreach(App\Models\Zakaznagruz::PEREZ_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('perez', $zakaznagruz->perez) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('perez'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DOP_1_T_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dop_1_t') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dop_1_t_{{ $key }}" name="dop_1_t" value="{{ $key }}" {{ old('dop_1_t', $zakaznagruz->dop_1_t) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_1_adr') ? 'is-invalid' : '' }}" type="text" name="dop_1_adr" id="dop_1_adr" value="{{ old('dop_1_adr', $zakaznagruz->dop_1_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_1_tot') ? 'is-invalid' : '' }}" type="text" name="dop_1_tot" id="dop_1_tot" value="{{ old('dop_1_tot', $zakaznagruz->dop_1_tot) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_1_val') ? 'is-invalid' : '' }}" name="dop_1_val_id" id="dop_1_val_id">
                    @foreach($dop_1_vals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_1_val_id') ? old('dop_1_val_id') : $zakaznagruz->dop_1_val->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_1_typ') ? 'is-invalid' : '' }}" name="dop_1_typ_id" id="dop_1_typ_id">
                    @foreach($dop_1_typs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_1_typ_id') ? old('dop_1_typ_id') : $zakaznagruz->dop_1_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_1_tam') ? 'is-invalid' : '' }}" name="dop_1_tam_id" id="dop_1_tam_id">
                    @foreach($dop_1_tams as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_1_tam_id') ? old('dop_1_tam_id') : $zakaznagruz->dop_1_tam->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DOP_2_T_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dop_2_t') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dop_2_t_{{ $key }}" name="dop_2_t" value="{{ $key }}" {{ old('dop_2_t', $zakaznagruz->dop_2_t) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_2_adr') ? 'is-invalid' : '' }}" type="text" name="dop_2_adr" id="dop_2_adr" value="{{ old('dop_2_adr', $zakaznagruz->dop_2_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_2_tot') ? 'is-invalid' : '' }}" type="text" name="dop_2_tot" id="dop_2_tot" value="{{ old('dop_2_tot', $zakaznagruz->dop_2_tot) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_2_val') ? 'is-invalid' : '' }}" name="dop_2_val_id" id="dop_2_val_id">
                    @foreach($dop_2_vals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_2_val_id') ? old('dop_2_val_id') : $zakaznagruz->dop_2_val->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_2_typ') ? 'is-invalid' : '' }}" name="dop_2_typ_id" id="dop_2_typ_id">
                    @foreach($dop_2_typs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_2_typ_id') ? old('dop_2_typ_id') : $zakaznagruz->dop_2_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_2_tam') ? 'is-invalid' : '' }}" name="dop_2_tam_id" id="dop_2_tam_id">
                    @foreach($dop_2_tams as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_2_tam_id') ? old('dop_2_tam_id') : $zakaznagruz->dop_2_tam->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DOP_3_T_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dop_3_t') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dop_3_t_{{ $key }}" name="dop_3_t" value="{{ $key }}" {{ old('dop_3_t', $zakaznagruz->dop_3_t) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_3_adr') ? 'is-invalid' : '' }}" type="text" name="dop_3_adr" id="dop_3_adr" value="{{ old('dop_3_adr', $zakaznagruz->dop_3_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_3_tot') ? 'is-invalid' : '' }}" type="text" name="dop_3_tot" id="dop_3_tot" value="{{ old('dop_3_tot', $zakaznagruz->dop_3_tot) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_3_val') ? 'is-invalid' : '' }}" name="dop_3_val_id" id="dop_3_val_id">
                    @foreach($dop_3_vals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_3_val_id') ? old('dop_3_val_id') : $zakaznagruz->dop_3_val->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_3_typ') ? 'is-invalid' : '' }}" name="dop_3_typ_id" id="dop_3_typ_id">
                    @foreach($dop_3_typs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_3_typ_id') ? old('dop_3_typ_id') : $zakaznagruz->dop_3_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_3_tam') ? 'is-invalid' : '' }}" name="dop_3_tam_id" id="dop_3_tam_id">
                    @foreach($dop_3_tams as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_3_tam_id') ? old('dop_3_tam_id') : $zakaznagruz->dop_3_tam->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DOP_4_T_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dop_4_t') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dop_4_t_{{ $key }}" name="dop_4_t" value="{{ $key }}" {{ old('dop_4_t', $zakaznagruz->dop_4_t) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_4_adr') ? 'is-invalid' : '' }}" type="text" name="dop_4_adr" id="dop_4_adr" value="{{ old('dop_4_adr', $zakaznagruz->dop_4_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_4_tot') ? 'is-invalid' : '' }}" type="text" name="dop_4_tot" id="dop_4_tot" value="{{ old('dop_4_tot', $zakaznagruz->dop_4_tot) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_4_val') ? 'is-invalid' : '' }}" name="dop_4_val_id" id="dop_4_val_id">
                    @foreach($dop_4_vals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_4_val_id') ? old('dop_4_val_id') : $zakaznagruz->dop_4_val->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_4_typ') ? 'is-invalid' : '' }}" name="dop_4_typ_id" id="dop_4_typ_id">
                    @foreach($dop_4_typs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_4_typ_id') ? old('dop_4_typ_id') : $zakaznagruz->dop_4_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_4_tam') ? 'is-invalid' : '' }}" name="dop_4_tam_id" id="dop_4_tam_id">
                    @foreach($dop_4_tams as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_4_tam_id') ? old('dop_4_tam_id') : $zakaznagruz->dop_4_tam->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Zakaznagruz::DOP_5_T_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dop_5_t') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dop_5_t_{{ $key }}" name="dop_5_t" value="{{ $key }}" {{ old('dop_5_t', $zakaznagruz->dop_5_t) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_5_adr') ? 'is-invalid' : '' }}" type="text" name="dop_5_adr" id="dop_5_adr" value="{{ old('dop_5_adr', $zakaznagruz->dop_5_adr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dop_5_tot') ? 'is-invalid' : '' }}" type="text" name="dop_5_tot" id="dop_5_tot" value="{{ old('dop_5_tot', $zakaznagruz->dop_5_tot) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_5_val') ? 'is-invalid' : '' }}" name="dop_5_val_id" id="dop_5_val_id">
                    @foreach($dop_5_vals as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_5_val_id') ? old('dop_5_val_id') : $zakaznagruz->dop_5_val->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_5_typ') ? 'is-invalid' : '' }}" name="dop_5_typ_id" id="dop_5_typ_id">
                    @foreach($dop_5_typs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_5_typ_id') ? old('dop_5_typ_id') : $zakaznagruz->dop_5_typ->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dop_5_tam') ? 'is-invalid' : '' }}" name="dop_5_tam_id" id="dop_5_tam_id">
                    @foreach($dop_5_tams as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dop_5_tam_id') ? old('dop_5_tam_id') : $zakaznagruz->dop_5_tam->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('di') ? 'is-invalid' : '' }}" type="text" name="di" id="di" value="{{ old('di', $zakaznagruz->di) }}">
                @if($errors->has('di'))
