...
<div class="card">
    <div class="card-header">
        <h4>Редактирование пункта погрузки/выгрузки</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input class="form-control mask-phone {{ $errors->has('mobileload') ? 'is-invalid' : '' }}" type="text" name="mobileload" id="mobileload" value="{{ old('mobileload', $pointload->mobileload) }}">
