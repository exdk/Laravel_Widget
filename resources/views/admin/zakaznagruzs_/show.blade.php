        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.zakaznagruz.fields.idcomp') }}
                        </th>
                        <td>
                            {{ $zakaznagruz->idcomp }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.zakaznagruz.fields.iduser') }}
                        </th>
                        <td>
                            {{ $zakaznagruz->iduser }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.zakaznagruz.fields.dop_1_adr') }}
                        </th>
                        <td>
                            {{ $zakaznagruz->dop_1_adr }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.zakaznagruz.fields.di') }}
                        </th>
                        <td>
                            {{ $zakaznagruz->di }}
                        </td>
