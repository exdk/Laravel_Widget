...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.rfqcountry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.rfqcountries.update", [$rfqcountry->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('rfq') ? 'is-invalid' : '' }}" name="rfq_id" id="rfq_id">
                    @foreach($rfqs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('rfq_id') ? old('rfq_id') : $rfqcountry->rfq->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('rfq'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('apoint') ? 'is-invalid' : '' }}" name="apoint_id" id="apoint_id">
                    @foreach($apoints as $id => $entry)
                        <option value="{{ $id }}" {{ (old('apoint_id') ? old('apoint_id') : $rfqcountry->apoint->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bpoint') ? 'is-invalid' : '' }}" name="bpoint_id" id="bpoint_id">
                    @foreach($bpoints as $id => $entry)
                        <option value="{{ $id }}" {{ (old('bpoint_id') ? old('bpoint_id') : $rfqcountry->bpoint->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_time') ? 'is-invalid' : '' }}" type="text" name="lead_time" id="lead_time" value="{{ old('lead_time', $rfqcountry->lead_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otif') ? 'is-invalid' : '' }}" type="text" name="otif" id="otif" value="{{ old('otif', $rfqcountry->otif) }}">
                @if($errors->has('otif'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('good') ? 'is-invalid' : '' }}" name="good_id" id="good_id">
                    @foreach($goods as $id => $entry)
                        <option value="{{ $id }}" {{ (old('good_id') ? old('good_id') : $rfqcountry->good->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('good'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pack') ? 'is-invalid' : '' }}" name="pack_id" id="pack_id">
                    @foreach($packs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('pack_id') ? old('pack_id') : $rfqcountry->pack->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('pack'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pack_weight') ? 'is-invalid' : '' }}" type="text" name="pack_weight" id="pack_weight" value="{{ old('pack_weight', $rfqcountry->pack_weight) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="text" name="qty" id="qty" value="{{ old('qty', $rfqcountry->qty) }}">
                @if($errors->has('qty'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty_auto') ? 'is-invalid' : '' }}" type="text" name="qty_auto" id="qty_auto" value="{{ old('qty_auto', $rfqcountry->qty_auto) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional') ? 'is-invalid' : '' }}" type="text" name="additional" id="additional" value="{{ old('additional', $rfqcountry->additional) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target') ? 'is-invalid' : '' }}" type="text" name="target" id="target" value="{{ old('target', $rfqcountry->target) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $rfqcountry->price) }}">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('garant') ? 'is-invalid' : '' }}" type="text" name="garant" id="garant" value="{{ old('garant', $rfqcountry->garant) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" type="text" name="comment" id="comment" value="{{ old('comment', $rfqcountry->comment) }}">
