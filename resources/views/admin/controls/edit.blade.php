...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.control.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.controls.update", [$control->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="i_dgruza">{{ trans('cruds.control.fields.i_dgruza') }}</label>
                <input class="form-control {{ $errors->has('i_dgruza') ? 'is-invalid' : '' }}" type="text" name="i_dgruza" id="i_dgruza" value="{{ old('i_dgruza', $control->i_dgruza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('load_reference_3') ? 'is-invalid' : '' }}" type="text" name="load_reference_3" id="load_reference_3" value="{{ old('load_reference_3', $control->load_reference_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('voditeli') ? 'is-invalid' : '' }}" type="text" name="voditeli" id="voditeli" value="{{ old('voditeli', $control->voditeli) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_otobrazheniay') ? 'is-invalid' : '' }}" type="text" name="statys_otobrazheniay" id="statys_otobrazheniay" value="{{ old('statys_otobrazheniay', $control->statys_otobrazheniay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_i_vremay_nachala') ? 'is-invalid' : '' }}" type="text" name="data_i_vremay_nachala" id="data_i_vremay_nachala" value="{{ old('data_i_vremay_nachala', $control->data_i_vremay_nachala) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adres_otpravleniya') ? 'is-invalid' : '' }}" type="text" name="adres_otpravleniya" id="adres_otpravleniya" value="{{ old('adres_otpravleniya', $control->adres_otpravleniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adres_mesta_naznacheniay') ? 'is-invalid' : '' }}" type="text" name="adres_mesta_naznacheniay" id="adres_mesta_naznacheniay" value="{{ old('adres_mesta_naznacheniay', $control->adres_mesta_naznacheniay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poslednee_sobitie') ? 'is-invalid' : '' }}" type="text" name="poslednee_sobitie" id="poslednee_sobitie" value="{{ old('poslednee_sobitie', $control->poslednee_sobitie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nazvanie_pynkta_naznacheniay') ? 'is-invalid' : '' }}" type="text" name="nazvanie_pynkta_naznacheniay" id="nazvanie_pynkta_naznacheniay" value="{{ old('nazvanie_pynkta_naznacheniay', $control->nazvanie_pynkta_naznacheniay) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip_oborydovaniay_treiler') ? 'is-invalid' : '' }}" type="text" name="tip_oborydovaniay_treiler" id="tip_oborydovaniay_treiler" value="{{ old('tip_oborydovaniay_treiler', $control->tip_oborydovaniay_treiler) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_tyagacha') ? 'is-invalid' : '' }}" type="text" name="nomer_tyagacha" id="nomer_tyagacha" value="{{ old('nomer_tyagacha', $control->nomer_tyagacha) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_vremya_zaversheniya') ? 'is-invalid' : '' }}" type="text" name="data_vremya_zaversheniya" id="data_vremya_zaversheniya" value="{{ old('data_vremya_zaversheniya', $control->data_vremya_zaversheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_reisa') ? 'is-invalid' : '' }}" type="text" name="identifikator_reisa" id="identifikator_reisa" value="{{ old('identifikator_reisa', $control->identifikator_reisa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolichestvo_edinich') ? 'is-invalid' : '' }}" type="text" name="kolichestvo_edinich" id="kolichestvo_edinich" value="{{ old('kolichestvo_edinich', $control->kolichestvo_edinich) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kolichestvo_osnovnih_ostanovok') ? 'is-invalid' : '' }}" type="text" name="kolichestvo_osnovnih_ostanovok" id="kolichestvo_osnovnih_ostanovok" value="{{ old('kolichestvo_osnovnih_ostanovok', $control->kolichestvo_osnovnih_ostanovok) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ves_kg') ? 'is-invalid' : '' }}" type="text" name="ves_kg" id="ves_kg" value="{{ old('ves_kg', $control->ves_kg) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kontaktnoe_lico') ? 'is-invalid' : '' }}" type="text" name="kontaktnoe_lico" id="kontaktnoe_lico" value="{{ old('kontaktnoe_lico', $control->kontaktnoe_lico) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_zakaza_postavshika_sirya_i_mat') ? 'is-invalid' : '' }}" type="text" name="nomer_zakaza_postavshika_sirya_i_mat" id="nomer_zakaza_postavshika_sirya_i_mat" value="{{ old('nomer_zakaza_postavshika_sirya_i_mat', $control->nomer_zakaza_postavshika_sirya_i_mat) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_posledovatelnosti_reisov') ? 'is-invalid' : '' }}" type="text" name="nomer_posledovatelnosti_reisov" id="nomer_posledovatelnosti_reisov" value="{{ old('nomer_posledovatelnosti_reisov', $control->nomer_posledovatelnosti_reisov) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('klient') ? 'is-invalid' : '' }}" type="text" name="klient" id="klient" value="{{ old('klient', $control->klient) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_treilera') ? 'is-invalid' : '' }}" type="text" name="nomer_treilera" id="nomer_treilera" value="{{ old('nomer_treilera', $control->nomer_treilera) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('obem_cu_m') ? 'is-invalid' : '' }}" type="text" name="obem_cu_m" id="obem_cu_m" value="{{ old('obem_cu_m', $control->obem_cu_m) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ostanovki_v_tranzite') ? 'is-invalid' : '' }}" type="text" name="ostanovki_v_tranzite" id="ostanovki_v_tranzite" value="{{ old('ostanovki_v_tranzite', $control->ostanovki_v_tranzite) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poddoni_dlya_perevozki_gryzov') ? 'is-invalid' : '' }}" type="text" name="poddoni_dlya_perevozki_gryzov" id="poddoni_dlya_perevozki_gryzov" value="{{ old('poddoni_dlya_perevozki_gryzov', $control->poddoni_dlya_perevozki_gryzov) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primechanie') ? 'is-invalid' : '' }}" type="text" name="primechanie" id="primechanie" value="{{ old('primechanie', $control->primechanie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rassoyanie_km') ? 'is-invalid' : '' }}" type="text" name="rassoyanie_km" id="rassoyanie_km" value="{{ old('rassoyanie_km', $control->rassoyanie_km) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('imya_klienta') ? 'is-invalid' : '' }}" type="text" name="imya_klienta" id="imya_klienta" value="{{ old('imya_klienta', $control->imya_klienta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_otpravleniya') ? 'is-invalid' : '' }}" type="text" name="gorod_otpravleniya" id="gorod_otpravleniya" value="{{ old('gorod_otpravleniya', $control->gorod_otpravleniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gorod_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="gorod_naznacheniya" id="gorod_naznacheniya" value="{{ old('gorod_naznacheniya', $control->gorod_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_bronirovaniya') ? 'is-invalid' : '' }}" type="text" name="identifikator_bronirovaniya" id="identifikator_bronirovaniya" value="{{ old('identifikator_bronirovaniya', $control->identifikator_bronirovaniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opisanie_tipa_transporta_treiler') ? 'is-invalid' : '' }}" type="text" name="opisanie_tipa_transporta_treiler" id="opisanie_tipa_transporta_treiler" value="{{ old('opisanie_tipa_transporta_treiler', $control->opisanie_tipa_transporta_treiler) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stoimost_zakaza_rub') ? 'is-invalid' : '' }}" type="text" name="stoimost_zakaza_rub" id="stoimost_zakaza_rub" value="{{ old('stoimost_zakaza_rub', $control->stoimost_zakaza_rub) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomer_otslezhivaniya_gryza') ? 'is-invalid' : '' }}" type="text" name="nomer_otslezhivaniya_gryza" id="nomer_otslezhivaniya_gryza" value="{{ old('nomer_otslezhivaniya_gryza', $control->nomer_otslezhivaniya_gryza) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('phakticheskaya_data_nachala_pogryzki') ? 'is-invalid' : '' }}" type="text" name="phakticheskaya_data_nachala_pogryzki" id="phakticheskaya_data_nachala_pogryzki" value="{{ old('phakticheskaya_data_nachala_pogryzki', $control->phakticheskaya_data_nachala_pogryzki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('load_reference_1') ? 'is-invalid' : '' }}" type="text" name="load_reference_1" id="load_reference_1" value="{{ old('load_reference_1', $control->load_reference_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_pynkta_otpravleniya') ? 'is-invalid' : '' }}" type="text" name="identifikator_pynkta_otpravleniya" id="identifikator_pynkta_otpravleniya" value="{{ old('identifikator_pynkta_otpravleniya', $control->identifikator_pynkta_otpravleniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_pynkta_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="identifikator_pynkta_naznacheniya" id="identifikator_pynkta_naznacheniya" value="{{ old('identifikator_pynkta_naznacheniya', $control->identifikator_pynkta_naznacheniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tovar') ? 'is-invalid' : '' }}" type="text" name="tovar" id="tovar" value="{{ old('tovar', $control->tovar) }}">
                @if($errors->has('tovar'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registracionnii_kod_18') ? 'is-invalid' : '' }}" type="text" name="registracionnii_kod_18" id="registracionnii_kod_18" value="{{ old('registracionnii_kod_18', $control->registracionnii_kod_18) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auction') ? 'is-invalid' : '' }}" type="text" name="auction" id="auction" value="{{ old('auction', $control->auction) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('load_reference_2') ? 'is-invalid' : '' }}" type="text" name="load_reference_2" id="load_reference_2" value="{{ old('load_reference_2', $control->load_reference_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pod_load_group') ? 'is-invalid' : '' }}" type="text" name="pod_load_group" id="pod_load_group" value="{{ old('pod_load_group', $control->pod_load_group) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pod_status') ? 'is-invalid' : '' }}" type="text" name="pod_status" id="pod_status" value="{{ old('pod_status', $control->pod_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sap_shipment_document_number') ? 'is-invalid' : '' }}" type="text" name="sap_shipment_document_number" id="sap_shipment_document_number" value="{{ old('sap_shipment_document_number', $control->sap_shipment_document_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adres_mesta_otpravleniya_sydna') ? 'is-invalid' : '' }}" type="text" name="adres_mesta_otpravleniya_sydna" id="adres_mesta_otpravleniya_sydna" value="{{ old('adres_mesta_otpravleniya_sydna', $control->adres_mesta_otpravleniya_sydna) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adres_mesta_pribitiya_sydna') ? 'is-invalid' : '' }}" type="text" name="adres_mesta_pribitiya_sydna" id="adres_mesta_pribitiya_sydna" value="{{ old('adres_mesta_pribitiya_sydna', $control->adres_mesta_pribitiya_sydna) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adres_svyazannogo_mesta_otpravleniya') ? 'is-invalid' : '' }}" type="text" name="adres_svyazannogo_mesta_otpravleniya" id="adres_svyazannogo_mesta_otpravleniya" value="{{ old('adres_svyazannogo_mesta_otpravleniya', $control->adres_svyazannogo_mesta_otpravleniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vklychit_v_cislo_ispolzovanii_resyrsa') ? 'is-invalid' : '' }}" type="text" name="vklychit_v_cislo_ispolzovanii_resyrsa" id="vklychit_v_cislo_ispolzovanii_resyrsa" value="{{ old('vklychit_v_cislo_ispolzovanii_resyrsa', $control->vklychit_v_cislo_ispolzovanii_resyrsa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vladelec_treilera') ? 'is-invalid' : '' }}" type="text" name="vladelec_treilera" id="vladelec_treilera" value="{{ old('vladelec_treilera', $control->vladelec_treilera) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vladelec_tyagacha') ? 'is-invalid' : '' }}" type="text" name="vladelec_tyagacha" id="vladelec_tyagacha" value="{{ old('vladelec_tyagacha', $control->vladelec_tyagacha) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnytrennii_n_zakaza_perevozchika') ? 'is-invalid' : '' }}" type="text" name="vnytrennii_n_zakaza_perevozchika" id="vnytrennii_n_zakaza_perevozchika" value="{{ old('vnytrennii_n_zakaza_perevozchika', $control->vnytrennii_n_zakaza_perevozchika) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vigryzka_bez_voditelya') ? 'is-invalid' : '' }}" type="text" name="vigryzka_bez_voditelya" id="vigryzka_bez_voditelya" value="{{ old('vigryzka_bez_voditelya', $control->vigryzka_bez_voditelya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_i_vremya_obnovleniya') ? 'is-invalid' : '' }}" type="text" name="data_i_vremya_obnovleniya" id="data_i_vremya_obnovleniya" value="{{ old('data_i_vremya_obnovleniya', $control->data_i_vremya_obnovleniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_i_vremya_sozdaniya') ? 'is-invalid' : '' }}" type="text" name="data_i_vremya_sozdaniya" id="data_i_vremya_sozdaniya" value="{{ old('data_i_vremya_sozdaniya', $control->data_i_vremya_sozdaniya) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('data_vremya_konteinernogo_sklada') ? 'is-invalid' : '' }}" type="text" name="data_vremya_konteinernogo_sklada" id="data_vremya_konteinernogo_sklada" value="{{ old('data_vremya_konteinernogo_sklada', $control->data_vremya_konteinernogo_sklada) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('datetimestartship') ? 'is-invalid' : '' }}" type="text" name="datetimestartship" id="datetimestartship" value="{{ old('datetimestartship', $control->datetimestartship) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('datetimearriveship') ? 'is-invalid' : '' }}" type="text" name="datetimearriveship" id="datetimearriveship" value="{{ old('datetimearriveship', $control->datetimearriveship) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_vremya_ocenki') ? 'is-invalid' : '' }}" type="text" name="data_vremya_ocenki" id="data_vremya_ocenki" value="{{ old('data_vremya_ocenki', $control->data_vremya_ocenki) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deklarirovannaya_stoimost') ? 'is-invalid' : '' }}" type="text" name="deklarirovannaya_stoimost" id="deklarirovannaya_stoimost" value="{{ old('deklarirovannaya_stoimost', $control->deklarirovannaya_stoimost) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_mesta_otpravlenia_sydna') ? 'is-invalid' : '' }}" type="text" name="identifikator_mesta_otpravlenia_sydna" id="identifikator_mesta_otpravlenia_sydna" value="{{ old('identifikator_mesta_otpravlenia_sydna', $control->identifikator_mesta_otpravlenia_sydna) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_mesta_pribitiya_sydna') ? 'is-invalid' : '' }}" type="text" name="identifikator_mesta_pribitiya_sydna" id="identifikator_mesta_pribitiya_sydna" value="{{ old('identifikator_mesta_pribitiya_sydna', $control->identifikator_mesta_pribitiya_sydna) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('identifikator_mesta_prpiski_treilera') ? 'is-invalid' : '' }}" type="text" name="identifikator_mesta_prpiski_treilera" id="identifikator_mesta_prpiski_treilera" value="{{ old('identifikator_mesta_prpiski_treilera', $control->identifikator_mesta_prpiski_treilera) }}">
