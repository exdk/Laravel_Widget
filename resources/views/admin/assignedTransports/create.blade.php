...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.assignedTransport.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.assigned-transports.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="first_date_loading">{{ trans('cruds.assignedTransport.fields.first_date_loading') }}</label>
                <input class="form-control date {{ $errors->has('first_date_loading') ? 'is-invalid' : '' }}" type="text" name="first_date_loading" id="first_date_loading" value="{{ old('first_date_loading') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="statys_vtoroe_bronirovanie" id="statys_vtoroe_bronirovanie" value="{{ old('statys_vtoroe_bronirovanie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip_pogryzki_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="tip_pogryzki_vtoroe_bronirovanie" id="tip_pogryzki_vtoroe_bronirovanie" value="{{ old('tip_pogryzki_vtoroe_bronirovanie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bronirovanie_zabronirovano') ? 'is-invalid' : '' }}" type="text" name="bronirovanie_zabronirovano" id="bronirovanie_zabronirovano" value="{{ old('bronirovanie_zabronirovano', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_yroven_perevozki') ? 'is-invalid' : '' }}" type="text" name="status_yroven_perevozki" id="status_yroven_perevozki" value="{{ old('status_yroven_perevozki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys_kem_razmeshcheno_yroven_perevozki') ? 'is-invalid' : '' }}" type="text" name="statys_kem_razmeshcheno_yroven_perevozki" id="statys_kem_razmeshcheno_yroven_perevozki" value="{{ old('statys_kem_razmeshcheno_yroven_perevozki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_yroven_postavki') ? 'is-invalid' : '' }}" type="text" name="status_yroven_postavki" id="status_yroven_postavki" value="{{ old('status_yroven_postavki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status_kem_razmeshcheno_yroven_postavki') ? 'is-invalid' : '' }}" type="text" name="status_kem_razmeshcheno_yroven_postavki" id="status_kem_razmeshcheno_yroven_postavki" value="{{ old('status_kem_razmeshcheno_yroven_postavki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip') ? 'is-invalid' : '' }}" type="text" name="tip" id="tip" value="{{ old('tip', '') }}">
                @if($errors->has('tip'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelnie_novera_gryzootpravitelya') ? 'is-invalid' : '' }}" type="text" name="dopolnitelnie_novera_gryzootpravitelya" id="dopolnitelnie_novera_gryzootpravitelya" value="{{ old('dopolnitelnie_novera_gryzootpravitelya', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dopolnitelniy_n_gryzootpravitelay_2') ? 'is-invalid' : '' }}" type="text" name="dopolnitelniy_n_gryzootpravitelay_2" id="dopolnitelniy_n_gryzootpravitelay_2" value="{{ old('dopolnitelniy_n_gryzootpravitelay_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vibrosi_co_2') ? 'is-invalid' : '' }}" type="text" name="vibrosi_co_2" id="vibrosi_co_2" value="{{ old('vibrosi_co_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registracionniy_n') ? 'is-invalid' : '' }}" type="text" name="registracionniy_n" id="registracionniy_n" value="{{ old('registracionniy_n', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vnytrenniy_kommentariy_k_perevozke') ? 'is-invalid' : '' }}" type="text" name="vnytrenniy_kommentariy_k_perevozke" id="vnytrenniy_kommentariy_k_perevozke" value="{{ old('vnytrenniy_kommentariy_k_perevozke', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statys') ? 'is-invalid' : '' }}" type="text" name="statys" id="statys" value="{{ old('statys', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pribitie') ? 'is-invalid' : '' }}" type="text" name="pribitie" id="pribitie" value="{{ old('pribitie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otbitie') ? 'is-invalid' : '' }}" type="text" name="otbitie" id="otbitie" value="{{ old('otbitie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tip_pogryzki') ? 'is-invalid' : '' }}" type="text" name="tip_pogryzki" id="tip_pogryzki" value="{{ old('tip_pogryzki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('statysi_razmestit_otslezhivanie_gryza') ? 'is-invalid' : '' }}" type="text" name="statysi_razmestit_otslezhivanie_gryza" id="statysi_razmestit_otslezhivanie_gryza" value="{{ old('statysi_razmestit_otslezhivanie_gryza', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spravochnaya_tsena_perevozki') ? 'is-invalid' : '' }}" type="text" name="spravochnaya_tsena_perevozki" id="spravochnaya_tsena_perevozki" value="{{ old('spravochnaya_tsena_perevozki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valyuta_ogovorennoy_tseni_perevozki') ? 'is-invalid' : '' }}" type="text" name="valyuta_ogovorennoy_tseni_perevozki" id="valyuta_ogovorennoy_tseni_perevozki" value="{{ old('valyuta_ogovorennoy_tseni_perevozki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomera_postavki') ? 'is-invalid' : '' }}" type="text" name="nomera_postavki" id="nomera_postavki" value="{{ old('nomera_postavki', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_pogryzki') ? 'is-invalid' : '' }}" type="text" name="data_pogryzki" id="data_pogryzki" value="{{ old('data_pogryzki') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('period_zagryzki') ? 'is-invalid' : '' }}" type="text" name="period_zagryzki" id="period_zagryzki" value="{{ old('period_zagryzki') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_razgryzki') ? 'is-invalid' : '' }}" type="text" name="data_razgryzki" id="data_razgryzki" value="{{ old('data_razgryzki') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('period_razgryzki') ? 'is-invalid' : '' }}" type="text" name="period_razgryzki" id="period_razgryzki" value="{{ old('period_razgryzki') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('poslednie_izmeneniya') ? 'is-invalid' : '' }}" type="text" name="poslednie_izmeneniya" id="poslednie_izmeneniya" value="{{ old('poslednie_izmeneniya') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('krayniy_srok') ? 'is-invalid' : '' }}" type="text" name="krayniy_srok" id="krayniy_srok" value="{{ old('krayniy_srok') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otslezhivanie') ? 'is-invalid' : '' }}" type="text" name="otslezhivanie" id="otslezhivanie" value="{{ old('otslezhivanie', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dta_statysa_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="dta_statysa_vtoroe_bronirovanie" id="dta_statysa_vtoroe_bronirovanie" value="{{ old('dta_statysa_vtoroe_bronirovanie') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('statys_data_statysa_yroven_perevozki') ? 'is-invalid' : '' }}" type="text" name="statys_data_statysa_yroven_perevozki" id="statys_data_statysa_yroven_perevozki" value="{{ old('statys_data_statysa_yroven_perevozki') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_statysa') ? 'is-invalid' : '' }}" type="text" name="data_statysa" id="data_statysa" value="{{ old('data_statysa') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('zabronirovano_s_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="zabronirovano_s_vtoroe_bronirovanie" id="zabronirovano_s_vtoroe_bronirovanie" value="{{ old('zabronirovano_s_vtoroe_bronirovanie') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_naznacheniya') ? 'is-invalid' : '' }}" type="text" name="data_naznacheniya" id="data_naznacheniya" value="{{ old('data_naznacheniya') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('pribitie_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="pribitie_vtoroe_bronirovanie" id="pribitie_vtoroe_bronirovanie" value="{{ old('pribitie_vtoroe_bronirovanie') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('zabronirovano_s') ? 'is-invalid' : '' }}" type="text" name="zabronirovano_s" id="zabronirovano_s" value="{{ old('zabronirovano_s') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('otbitie_vtoroe_bronirovanie') ? 'is-invalid' : '' }}" type="text" name="otbitie_vtoroe_bronirovanie" id="otbitie_vtoroe_bronirovanie" value="{{ old('otbitie_vtoroe_bronirovanie') }}">
